...
# Unit tests for Spatio::NotificationsApi
...
describe 'NotificationsApi' do
  ...
  describe 'test an instance of NotificationsApi' do
    it 'should create an instance of NotificationsApi' do
      expect(@api_instance).to be_instance_of(Spatio::NotificationsApi)
    end
  end

  # unit tests for get_notification_preferences
  # Read the caller&#39;s notification preferences.
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe 'get_notification_preferences test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_notification_preferences
  # Update notification preferences.
  # @param request_body 
  # @param [Hash] opts the optional parameters
  # @return [Hash<String, Object>]
  describe 'update_notification_preferences test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
