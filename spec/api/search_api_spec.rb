...
# Unit tests for Spatio::SearchApi
...
describe 'SearchApi' do
  ...
  describe 'test an instance of SearchApi' do
    it 'should create an instance of SearchApi' do
      expect(@api_instance).to be_instance_of(Spatio::SearchApi)
    end
  end

  # unit tests for federated_search
  ...
  # @param federated_search_request 
  # @param [Hash] opts the optional parameters
  # @return [FederatedSearch200Response]
  describe 'federated_search test' do
    it 'should work' do
