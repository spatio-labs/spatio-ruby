...
# Unit tests for Spatio::KeyBinding
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::KeyBinding do
  #let(:instance) { Spatio::KeyBinding.new }

  describe 'test an instance of KeyBinding' do
    it 'should create an instance of KeyBinding' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::KeyBinding)
    end
  end
