...
# Unit tests for Spatio::ListCalendarEvents200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListCalendarEvents200Response do
  #let(:instance) { Spatio::ListCalendarEvents200Response.new }
  ...
  describe 'test an instance of ListCalendarEvents200Response' do
    it 'should create an instance of ListCalendarEvents200Response' do
      ...
      #expect(instance).to be_instance_of(Spatio::ListCalendarEvents200Response)
    end
  end
