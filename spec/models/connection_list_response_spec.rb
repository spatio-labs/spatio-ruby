...
# Unit tests for Spatio::ConnectionListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConnectionListResponse do
  #let(:instance) { Spatio::ConnectionListResponse.new }

  describe 'test an instance of ConnectionListResponse' do
    it 'should create an instance of ConnectionListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConnectionListResponse)
    end
  end
