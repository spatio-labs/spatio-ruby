...
# Unit tests for Spatio::TaskCommentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskCommentRequest do
  #let(:instance) { Spatio::TaskCommentRequest.new }

  describe 'test an instance of TaskCommentRequest' do
    it 'should create an instance of TaskCommentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskCommentRequest)
    end
  end
