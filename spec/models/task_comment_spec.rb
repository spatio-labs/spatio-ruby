...
# Unit tests for Spatio::TaskComment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskComment do
  #let(:instance) { Spatio::TaskComment.new }

  describe 'test an instance of TaskComment' do
    it 'should create an instance of TaskComment' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskComment)
    end
  end
