...
# Unit tests for Spatio::Sheet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Sheet do
  #let(:instance) { Spatio::Sheet.new }

  describe 'test an instance of Sheet' do
    it 'should create an instance of Sheet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Sheet)
    end
  end
  ...
  describe 'test attribute "sheet_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
