...
# Unit tests for Spatio::ContactProviderListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ContactProviderListResponse do
  #let(:instance) { Spatio::ContactProviderListResponse.new }

  describe 'test an instance of ContactProviderListResponse' do
    it 'should create an instance of ContactProviderListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ContactProviderListResponse)
    end
  end
