...
# Unit tests for Spatio::UpdateEmailFolderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateEmailFolderRequest do
  #let(:instance) { Spatio::UpdateEmailFolderRequest.new }

  describe 'test an instance of UpdateEmailFolderRequest' do
    it 'should create an instance of UpdateEmailFolderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateEmailFolderRequest)
    end
  end
