...
# Unit tests for Spatio::BulkDeleteEmailsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteEmailsResponse do
  #let(:instance) { Spatio::BulkDeleteEmailsResponse.new }

  describe 'test an instance of BulkDeleteEmailsResponse' do
    it 'should create an instance of BulkDeleteEmailsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteEmailsResponse)
    end
  end
