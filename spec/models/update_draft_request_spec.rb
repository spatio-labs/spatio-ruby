...
# Unit tests for Spatio::UpdateDraftRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateDraftRequest do
  #let(:instance) { Spatio::UpdateDraftRequest.new }

  describe 'test an instance of UpdateDraftRequest' do
    it 'should create an instance of UpdateDraftRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateDraftRequest)
    end
  end
