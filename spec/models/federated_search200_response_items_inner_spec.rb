...
# Unit tests for Spatio::FederatedSearch200ResponseItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FederatedSearch200ResponseItemsInner do
  #let(:instance) { Spatio::FederatedSearch200ResponseItemsInner.new }

  describe 'test an instance of FederatedSearch200ResponseItemsInner' do
    it 'should create an instance of FederatedSearch200ResponseItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FederatedSearch200ResponseItemsInner)
    end
  end
