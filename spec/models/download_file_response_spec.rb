...
# Unit tests for Spatio::DownloadFileResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DownloadFileResponse do
  #let(:instance) { Spatio::DownloadFileResponse.new }

  describe 'test an instance of DownloadFileResponse' do
    it 'should create an instance of DownloadFileResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DownloadFileResponse)
    end
  end
