...
# Unit tests for Spatio::CalendarSyncResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarSyncResponse do
  #let(:instance) { Spatio::CalendarSyncResponse.new }

  describe 'test an instance of CalendarSyncResponse' do
    it 'should create an instance of CalendarSyncResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarSyncResponse)
    end
  end

  describe 'test attribute "enqueued"' do
    it 'should work' do
  ...
  describe 'test attribute "waited"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
