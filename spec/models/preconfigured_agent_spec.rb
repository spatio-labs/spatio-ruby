...
# Unit tests for Spatio::PreconfiguredAgent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PreconfiguredAgent do
  #let(:instance) { Spatio::PreconfiguredAgent.new }

  describe 'test an instance of PreconfiguredAgent' do
    it 'should create an instance of PreconfiguredAgent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PreconfiguredAgent)
    end
  end
  ...
  describe 'test attribute "has_all_tools"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "tool_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
