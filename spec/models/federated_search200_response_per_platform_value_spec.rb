...
# Unit tests for Spatio::FederatedSearch200ResponsePerPlatformValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FederatedSearch200ResponsePerPlatformValue do
  #let(:instance) { Spatio::FederatedSearch200ResponsePerPlatformValue.new }

  describe 'test an instance of FederatedSearch200ResponsePerPlatformValue' do
    it 'should create an instance of FederatedSearch200ResponsePerPlatformValue' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FederatedSearch200ResponsePerPlatformValue)
    end
  end
