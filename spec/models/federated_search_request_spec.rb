...
# Unit tests for Spatio::FederatedSearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FederatedSearchRequest do
  #let(:instance) { Spatio::FederatedSearchRequest.new }

  describe 'test an instance of FederatedSearchRequest' do
    it 'should create an instance of FederatedSearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FederatedSearchRequest)
    end
  end
  ...
  describe 'test attribute "platforms"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["notes", "tasks", "mail", "calendar", "files"])
  ...
  describe 'test attribute "page_tokens"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "include_shared"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
