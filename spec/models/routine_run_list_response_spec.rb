...
# Unit tests for Spatio::RoutineRunListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RoutineRunListResponse do
  #let(:instance) { Spatio::RoutineRunListResponse.new }

  describe 'test an instance of RoutineRunListResponse' do
    it 'should create an instance of RoutineRunListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RoutineRunListResponse)
    end
  end
