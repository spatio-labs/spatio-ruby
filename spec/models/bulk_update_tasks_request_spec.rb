...
# Unit tests for Spatio::BulkUpdateTasksRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkUpdateTasksRequest do
  #let(:instance) { Spatio::BulkUpdateTasksRequest.new }

  describe 'test an instance of BulkUpdateTasksRequest' do
    it 'should create an instance of BulkUpdateTasksRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkUpdateTasksRequest)
    end
  end
