...
# Unit tests for Spatio::CreateLabelRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateLabelRequest do
  #let(:instance) { Spatio::CreateLabelRequest.new }

  describe 'test an instance of CreateLabelRequest' do
    it 'should create an instance of CreateLabelRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateLabelRequest)
    end
  end
  ...
  describe 'test attribute "message_list_visibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "label_list_visibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
