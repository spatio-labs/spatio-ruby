...
# Unit tests for Spatio::ExecuteChatActionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExecuteChatActionRequest do
  #let(:instance) { Spatio::ExecuteChatActionRequest.new }

  describe 'test an instance of ExecuteChatActionRequest' do
    it 'should create an instance of ExecuteChatActionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExecuteChatActionRequest)
    end
  end
