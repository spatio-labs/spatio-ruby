...
# Unit tests for Spatio::RoutineRunProgressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RoutineRunProgressRequest do
  #let(:instance) { Spatio::RoutineRunProgressRequest.new }

  describe 'test an instance of RoutineRunProgressRequest' do
    it 'should create an instance of RoutineRunProgressRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RoutineRunProgressRequest)
    end
  end
