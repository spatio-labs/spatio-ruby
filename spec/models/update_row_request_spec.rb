...
# Unit tests for Spatio::UpdateRowRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateRowRequest do
  #let(:instance) { Spatio::UpdateRowRequest.new }

  describe 'test an instance of UpdateRowRequest' do
    it 'should create an instance of UpdateRowRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateRowRequest)
    end
  end
