...
# Unit tests for Spatio::ConnectedAppsListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConnectedAppsListResponse do
  #let(:instance) { Spatio::ConnectedAppsListResponse.new }

  describe 'test an instance of ConnectedAppsListResponse' do
    it 'should create an instance of ConnectedAppsListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConnectedAppsListResponse)
    end
  end
