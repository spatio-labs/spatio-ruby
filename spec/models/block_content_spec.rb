...
# Unit tests for Spatio::BlockContent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BlockContent do
  #let(:instance) { Spatio::BlockContent.new }

  describe 'test an instance of BlockContent' do
    it 'should create an instance of BlockContent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BlockContent)
    end
  end
