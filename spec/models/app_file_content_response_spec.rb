...
# Unit tests for Spatio::AppFileContentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AppFileContentResponse do
  #let(:instance) { Spatio::AppFileContentResponse.new }

  describe 'test an instance of AppFileContentResponse' do
    it 'should create an instance of AppFileContentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AppFileContentResponse)
    end
  end
