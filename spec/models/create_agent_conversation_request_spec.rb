...
# Unit tests for Spatio::CreateAgentConversationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateAgentConversationRequest do
  #let(:instance) { Spatio::CreateAgentConversationRequest.new }

  describe 'test an instance of CreateAgentConversationRequest' do
    it 'should create an instance of CreateAgentConversationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateAgentConversationRequest)
    end
  end
