...
# Unit tests for Spatio::AgentSessionContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentSessionContext do
  #let(:instance) { Spatio::AgentSessionContext.new }

  describe 'test an instance of AgentSessionContext' do
    it 'should create an instance of AgentSessionContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentSessionContext)
    end
  end
  ...
  describe 'test attribute "current_workspace"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
