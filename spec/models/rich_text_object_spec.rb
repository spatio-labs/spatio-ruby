...
# Unit tests for Spatio::RichTextObject
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RichTextObject do
  #let(:instance) { Spatio::RichTextObject.new }

  describe 'test an instance of RichTextObject' do
    it 'should create an instance of RichTextObject' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RichTextObject)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["text", "mention", "equation"])
