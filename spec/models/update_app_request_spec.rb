...
# Unit tests for Spatio::UpdateAppRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateAppRequest do
  #let(:instance) { Spatio::UpdateAppRequest.new }

  describe 'test an instance of UpdateAppRequest' do
    it 'should create an instance of UpdateAppRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateAppRequest)
    end
  end
