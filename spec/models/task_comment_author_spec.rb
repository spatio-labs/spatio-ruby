...
# Unit tests for Spatio::TaskCommentAuthor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskCommentAuthor do
  #let(:instance) { Spatio::TaskCommentAuthor.new }

  describe 'test an instance of TaskCommentAuthor' do
    it 'should create an instance of TaskCommentAuthor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskCommentAuthor)
    end
  end
