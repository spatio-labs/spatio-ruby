...
# Unit tests for Spatio::ExecuteChatActionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExecuteChatActionResponse do
  #let(:instance) { Spatio::ExecuteChatActionResponse.new }

  describe 'test an instance of ExecuteChatActionResponse' do
    it 'should create an instance of ExecuteChatActionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExecuteChatActionResponse)
    end
  end
