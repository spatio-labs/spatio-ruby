...
# Unit tests for Spatio::BulkArchiveResponseFailedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkArchiveResponseFailedInner do
  #let(:instance) { Spatio::BulkArchiveResponseFailedInner.new }

  describe 'test an instance of BulkArchiveResponseFailedInner' do
    it 'should create an instance of BulkArchiveResponseFailedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkArchiveResponseFailedInner)
    end
  end
