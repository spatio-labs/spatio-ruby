...
# Unit tests for Spatio::BulkUpdateTasksResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkUpdateTasksResponse do
  #let(:instance) { Spatio::BulkUpdateTasksResponse.new }

  describe 'test an instance of BulkUpdateTasksResponse' do
    it 'should create an instance of BulkUpdateTasksResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkUpdateTasksResponse)
    end
  end
  ...
  describe 'test attribute "affected_count"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
