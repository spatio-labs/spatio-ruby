...
# Unit tests for Spatio::WorkspaceEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceEnvelope do
  #let(:instance) { Spatio::WorkspaceEnvelope.new }

  describe 'test an instance of WorkspaceEnvelope' do
    it 'should create an instance of WorkspaceEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceEnvelope)
    end
  end
