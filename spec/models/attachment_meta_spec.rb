...
# Unit tests for Spatio::AttachmentMeta
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AttachmentMeta do
  #let(:instance) { Spatio::AttachmentMeta.new }

  describe 'test an instance of AttachmentMeta' do
    it 'should create an instance of AttachmentMeta' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AttachmentMeta)
    end
  end
