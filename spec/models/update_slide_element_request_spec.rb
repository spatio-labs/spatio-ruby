...
# Unit tests for Spatio::UpdateSlideElementRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateSlideElementRequest do
  #let(:instance) { Spatio::UpdateSlideElementRequest.new }

  describe 'test an instance of UpdateSlideElementRequest' do
    it 'should create an instance of UpdateSlideElementRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateSlideElementRequest)
    end
  end
