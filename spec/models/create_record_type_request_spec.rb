...
# Unit tests for Spatio::CreateRecordTypeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateRecordTypeRequest do
  #let(:instance) { Spatio::CreateRecordTypeRequest.new }

  describe 'test an instance of CreateRecordTypeRequest' do
    it 'should create an instance of CreateRecordTypeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateRecordTypeRequest)
    end
  end
  ...
  describe 'test attribute "attribute_schema"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
