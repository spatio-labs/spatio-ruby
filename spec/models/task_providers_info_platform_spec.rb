...
# Unit tests for Spatio::TaskProvidersInfoPlatform
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskProvidersInfoPlatform do
  #let(:instance) { Spatio::TaskProvidersInfoPlatform.new }

  describe 'test an instance of TaskProvidersInfoPlatform' do
    it 'should create an instance of TaskProvidersInfoPlatform' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskProvidersInfoPlatform)
    end
  end
