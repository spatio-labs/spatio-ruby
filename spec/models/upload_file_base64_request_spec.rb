...
# Unit tests for Spatio::UploadFileBase64Request
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UploadFileBase64Request do
  #let(:instance) { Spatio::UploadFileBase64Request.new }

  describe 'test an instance of UploadFileBase64Request' do
    it 'should create an instance of UploadFileBase64Request' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UploadFileBase64Request)
    end
  end
