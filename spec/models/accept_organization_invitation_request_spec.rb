...
# Unit tests for Spatio::AcceptOrganizationInvitationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AcceptOrganizationInvitationRequest do
  #let(:instance) { Spatio::AcceptOrganizationInvitationRequest.new }

  describe 'test an instance of AcceptOrganizationInvitationRequest' do
    it 'should create an instance of AcceptOrganizationInvitationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AcceptOrganizationInvitationRequest)
    end
  end
