...
# Unit tests for Spatio::FederatedSearch200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FederatedSearch200Response do
  #let(:instance) { Spatio::FederatedSearch200Response.new }

  describe 'test an instance of FederatedSearch200Response' do
    it 'should create an instance of FederatedSearch200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FederatedSearch200Response)
    end
  end
  ...
  describe 'test attribute "next_page_tokens"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "per_platform"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
