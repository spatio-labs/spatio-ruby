...
# Unit tests for Spatio::RecordTypeListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RecordTypeListResponse do
  #let(:instance) { Spatio::RecordTypeListResponse.new }

  describe 'test an instance of RecordTypeListResponse' do
    it 'should create an instance of RecordTypeListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RecordTypeListResponse)
    end
  end
