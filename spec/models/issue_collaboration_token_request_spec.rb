...
# Unit tests for Spatio::IssueCollaborationTokenRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::IssueCollaborationTokenRequest do
  #let(:instance) { Spatio::IssueCollaborationTokenRequest.new }

  describe 'test an instance of IssueCollaborationTokenRequest' do
    it 'should create an instance of IssueCollaborationTokenRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::IssueCollaborationTokenRequest)
    end
  end
