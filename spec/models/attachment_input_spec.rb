...
# Unit tests for Spatio::AttachmentInput
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AttachmentInput do
  #let(:instance) { Spatio::AttachmentInput.new }

  describe 'test an instance of AttachmentInput' do
    it 'should create an instance of AttachmentInput' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AttachmentInput)
    end
  end
