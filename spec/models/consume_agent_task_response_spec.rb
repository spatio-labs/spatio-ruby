...
# Unit tests for Spatio::ConsumeAgentTaskResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConsumeAgentTaskResponse do
  #let(:instance) { Spatio::ConsumeAgentTaskResponse.new }

  describe 'test an instance of ConsumeAgentTaskResponse' do
    it 'should create an instance of ConsumeAgentTaskResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConsumeAgentTaskResponse)
    end
  end
