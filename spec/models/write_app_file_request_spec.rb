...
# Unit tests for Spatio::WriteAppFileRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WriteAppFileRequest do
  #let(:instance) { Spatio::WriteAppFileRequest.new }

  describe 'test an instance of WriteAppFileRequest' do
    it 'should create an instance of WriteAppFileRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WriteAppFileRequest)
    end
  end
