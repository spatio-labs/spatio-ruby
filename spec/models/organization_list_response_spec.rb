...
# Unit tests for Spatio::OrganizationListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationListResponse do
  #let(:instance) { Spatio::OrganizationListResponse.new }
  ...
  describe 'test an instance of OrganizationListResponse' do
    it 'should create an instance of OrganizationListResponse' do
      ...
      #expect(instance).to be_instance_of(Spatio::OrganizationListResponse)
    end
  end
