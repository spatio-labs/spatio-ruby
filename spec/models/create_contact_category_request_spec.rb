...
# Unit tests for Spatio::CreateContactCategoryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateContactCategoryRequest do
  #let(:instance) { Spatio::CreateContactCategoryRequest.new }

  describe 'test an instance of CreateContactCategoryRequest' do
    it 'should create an instance of CreateContactCategoryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateContactCategoryRequest)
    end
  end
