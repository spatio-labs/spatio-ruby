...
# Unit tests for Spatio::ChatUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChatUser do
  #let(:instance) { Spatio::ChatUser.new }

  describe 'test an instance of ChatUser' do
    it 'should create an instance of ChatUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChatUser)
    end
  end
