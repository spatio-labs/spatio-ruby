...
# Unit tests for Spatio::ConversationMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConversationMessage do
  #let(:instance) { Spatio::ConversationMessage.new }

  describe 'test an instance of ConversationMessage' do
    it 'should create an instance of ConversationMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConversationMessage)
    end
  end
