...
# Unit tests for Spatio::EmailFolder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::EmailFolder do
  #let(:instance) { Spatio::EmailFolder.new }

  describe 'test an instance of EmailFolder' do
    it 'should create an instance of EmailFolder' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::EmailFolder)
    end
  end
