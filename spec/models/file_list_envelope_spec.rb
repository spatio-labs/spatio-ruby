...
# Unit tests for Spatio::FileListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FileListEnvelope do
  #let(:instance) { Spatio::FileListEnvelope.new }

  describe 'test an instance of FileListEnvelope' do
    it 'should create an instance of FileListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FileListEnvelope)
    end
  end
