...
# Unit tests for Spatio::RoutineRun
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RoutineRun do
  #let(:instance) { Spatio::RoutineRun.new }

  describe 'test an instance of RoutineRun' do
    it 'should create an instance of RoutineRun' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RoutineRun)
    end
  end
  ...
  describe 'test attribute "routine_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
