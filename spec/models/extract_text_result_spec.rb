...
# Unit tests for Spatio::ExtractTextResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExtractTextResult do
  #let(:instance) { Spatio::ExtractTextResult.new }

  describe 'test an instance of ExtractTextResult' do
    it 'should create an instance of ExtractTextResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExtractTextResult)
    end
  end
