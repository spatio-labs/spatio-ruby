...
# Unit tests for Spatio::ValidateKeyBindingResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ValidateKeyBindingResponse do
  #let(:instance) { Spatio::ValidateKeyBindingResponse.new }

  describe 'test an instance of ValidateKeyBindingResponse' do
    it 'should create an instance of ValidateKeyBindingResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ValidateKeyBindingResponse)
    end
  end
