...
# Unit tests for Spatio::AppFileListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AppFileListResponse do
  #let(:instance) { Spatio::AppFileListResponse.new }

  describe 'test an instance of AppFileListResponse' do
    it 'should create an instance of AppFileListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AppFileListResponse)
    end
  end
