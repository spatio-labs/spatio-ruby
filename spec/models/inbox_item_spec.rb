...
# Unit tests for Spatio::InboxItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InboxItem do
  #let(:instance) { Spatio::InboxItem.new }

  describe 'test an instance of InboxItem' do
    it 'should create an instance of InboxItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InboxItem)
    end
  end
  ...
  describe 'test attribute "is_mention"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
