...
# Unit tests for Spatio::ListLabelsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListLabelsResponse do
  #let(:instance) { Spatio::ListLabelsResponse.new }

  describe 'test an instance of ListLabelsResponse' do
    it 'should create an instance of ListLabelsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListLabelsResponse)
    end
  end
