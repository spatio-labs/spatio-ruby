...
# Unit tests for Spatio::CalendarOperationResult
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarOperationResult do
  #let(:instance) { Spatio::CalendarOperationResult.new }

  describe 'test an instance of CalendarOperationResult' do
    it 'should create an instance of CalendarOperationResult' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarOperationResult)
    end
  end
