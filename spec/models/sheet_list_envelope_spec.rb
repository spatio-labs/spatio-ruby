...
# Unit tests for Spatio::SheetListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SheetListEnvelope do
  #let(:instance) { Spatio::SheetListEnvelope.new }

  describe 'test an instance of SheetListEnvelope' do
    it 'should create an instance of SheetListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SheetListEnvelope)
    end
  end
