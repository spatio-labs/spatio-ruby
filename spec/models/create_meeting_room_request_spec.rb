...
# Unit tests for Spatio::CreateMeetingRoomRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateMeetingRoomRequest do
  #let(:instance) { Spatio::CreateMeetingRoomRequest.new }

  describe 'test an instance of CreateMeetingRoomRequest' do
    it 'should create an instance of CreateMeetingRoomRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateMeetingRoomRequest)
    end
  end
