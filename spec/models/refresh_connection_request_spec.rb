...
# Unit tests for Spatio::RefreshConnectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RefreshConnectionRequest do
  #let(:instance) { Spatio::RefreshConnectionRequest.new }

  describe 'test an instance of RefreshConnectionRequest' do
    it 'should create an instance of RefreshConnectionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RefreshConnectionRequest)
    end
  end
