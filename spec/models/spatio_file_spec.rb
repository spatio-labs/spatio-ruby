...
# Unit tests for Spatio::SpatioFile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SpatioFile do
  #let(:instance) { Spatio::SpatioFile.new }

  describe 'test an instance of SpatioFile' do
    it 'should create an instance of SpatioFile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SpatioFile)
    end
  end
