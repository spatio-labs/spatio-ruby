...
# Unit tests for Spatio::UpdateOrganizationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateOrganizationRequest do
  #let(:instance) { Spatio::UpdateOrganizationRequest.new }
  ...
  describe 'test an instance of UpdateOrganizationRequest' do
    it 'should create an instance of UpdateOrganizationRequest' do
      ...
      #expect(instance).to be_instance_of(Spatio::UpdateOrganizationRequest)
    end
  end
