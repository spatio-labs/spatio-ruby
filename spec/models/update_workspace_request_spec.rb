...
# Unit tests for Spatio::UpdateWorkspaceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateWorkspaceRequest do
  #let(:instance) { Spatio::UpdateWorkspaceRequest.new }

  describe 'test an instance of UpdateWorkspaceRequest' do
    it 'should create an instance of UpdateWorkspaceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateWorkspaceRequest)
    end
  end
