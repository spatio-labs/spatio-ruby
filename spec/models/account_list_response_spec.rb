...
# Unit tests for Spatio::AccountListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AccountListResponse do
  #let(:instance) { Spatio::AccountListResponse.new }

  describe 'test an instance of AccountListResponse' do
    it 'should create an instance of AccountListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AccountListResponse)
    end
  end

  describe 'test attribute "accounts_by_platform"' do
    it 'should work' do
