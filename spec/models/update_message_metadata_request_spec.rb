...
# Unit tests for Spatio::UpdateMessageMetadataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateMessageMetadataRequest do
  #let(:instance) { Spatio::UpdateMessageMetadataRequest.new }

  describe 'test an instance of UpdateMessageMetadataRequest' do
    it 'should create an instance of UpdateMessageMetadataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateMessageMetadataRequest)
    end
  end
