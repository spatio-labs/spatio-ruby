...
# Unit tests for Spatio::SignInMethodsProvidersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SignInMethodsProvidersInner do
  #let(:instance) { Spatio::SignInMethodsProvidersInner.new }

  describe 'test an instance of SignInMethodsProvidersInner' do
    it 'should create an instance of SignInMethodsProvidersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SignInMethodsProvidersInner)
    end
  end
