...
# Unit tests for Spatio::OrganizationInvitationListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationInvitationListResponse do
  #let(:instance) { Spatio::OrganizationInvitationListResponse.new }

  describe 'test an instance of OrganizationInvitationListResponse' do
    it 'should create an instance of OrganizationInvitationListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OrganizationInvitationListResponse)
    end
  end
