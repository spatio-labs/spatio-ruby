...
# Unit tests for Spatio::CreateAgentMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateAgentMessageRequest do
  #let(:instance) { Spatio::CreateAgentMessageRequest.new }

  describe 'test an instance of CreateAgentMessageRequest' do
    it 'should create an instance of CreateAgentMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateAgentMessageRequest)
    end
  end
