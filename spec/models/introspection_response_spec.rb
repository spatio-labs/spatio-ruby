...
# Unit tests for Spatio::IntrospectionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::IntrospectionResponse do
  #let(:instance) { Spatio::IntrospectionResponse.new }

  describe 'test an instance of IntrospectionResponse' do
    it 'should create an instance of IntrospectionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::IntrospectionResponse)
    end
  end
