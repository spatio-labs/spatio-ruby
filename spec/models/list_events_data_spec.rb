...
# Unit tests for Spatio::ListEventsData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListEventsData do
  #let(:instance) { Spatio::ListEventsData.new }

  describe 'test an instance of ListEventsData' do
    it 'should create an instance of ListEventsData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListEventsData)
    end
  end
