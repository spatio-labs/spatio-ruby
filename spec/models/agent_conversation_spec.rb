...
# Unit tests for Spatio::AgentConversation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentConversation do
  #let(:instance) { Spatio::AgentConversation.new }

  describe 'test an instance of AgentConversation' do
    it 'should create an instance of AgentConversation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentConversation)
    end
  end
