...
# Unit tests for Spatio::ExportPDFRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExportPDFRequest do
  #let(:instance) { Spatio::ExportPDFRequest.new }

  describe 'test an instance of ExportPDFRequest' do
    it 'should create an instance of ExportPDFRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExportPDFRequest)
    end
  end

  describe 'test attribute "rasterized_slides"' do
    it 'should work' do
