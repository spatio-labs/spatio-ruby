...
# Unit tests for Spatio::BulkMarkReadResponseFailedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkMarkReadResponseFailedInner do
  #let(:instance) { Spatio::BulkMarkReadResponseFailedInner.new }

  describe 'test an instance of BulkMarkReadResponseFailedInner' do
    it 'should create an instance of BulkMarkReadResponseFailedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkMarkReadResponseFailedInner)
    end
  end
