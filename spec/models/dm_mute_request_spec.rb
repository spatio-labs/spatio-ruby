...
# Unit tests for Spatio::DMMuteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMMuteRequest do
  #let(:instance) { Spatio::DMMuteRequest.new }

  describe 'test an instance of DMMuteRequest' do
    it 'should create an instance of DMMuteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMMuteRequest)
    end
  end

  describe 'test attribute "until_seconds"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "forever"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
