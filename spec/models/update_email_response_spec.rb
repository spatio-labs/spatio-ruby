...
# Unit tests for Spatio::UpdateEmailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateEmailResponse do
  #let(:instance) { Spatio::UpdateEmailResponse.new }

  describe 'test an instance of UpdateEmailResponse' do
    it 'should create an instance of UpdateEmailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateEmailResponse)
    end
  end
