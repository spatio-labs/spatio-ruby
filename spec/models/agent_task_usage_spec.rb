...
# Unit tests for Spatio::AgentTaskUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentTaskUsage do
  #let(:instance) { Spatio::AgentTaskUsage.new }

  describe 'test an instance of AgentTaskUsage' do
    it 'should create an instance of AgentTaskUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentTaskUsage)
    end
  end
