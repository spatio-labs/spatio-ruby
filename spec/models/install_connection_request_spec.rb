...
# Unit tests for Spatio::InstallConnectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InstallConnectionRequest do
  #let(:instance) { Spatio::InstallConnectionRequest.new }

  describe 'test an instance of InstallConnectionRequest' do
    it 'should create an instance of InstallConnectionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InstallConnectionRequest)
    end
  end
