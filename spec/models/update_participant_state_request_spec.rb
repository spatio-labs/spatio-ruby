...
# Unit tests for Spatio::UpdateParticipantStateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateParticipantStateRequest do
  #let(:instance) { Spatio::UpdateParticipantStateRequest.new }

  describe 'test an instance of UpdateParticipantStateRequest' do
    it 'should create an instance of UpdateParticipantStateRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateParticipantStateRequest)
    end
  end

  describe 'test attribute "audio_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "video_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "screen_share_enabled"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
