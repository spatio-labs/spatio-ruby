...
# Unit tests for Spatio::MoveFileRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::MoveFileRequest do
  #let(:instance) { Spatio::MoveFileRequest.new }

  describe 'test an instance of MoveFileRequest' do
    it 'should create an instance of MoveFileRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::MoveFileRequest)
    end
  end
