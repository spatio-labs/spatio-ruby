...
# Unit tests for Spatio::CreateAgentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateAgentRequest do
  #let(:instance) { Spatio::CreateAgentRequest.new }

  describe 'test an instance of CreateAgentRequest' do
    it 'should create an instance of CreateAgentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateAgentRequest)
    end
  end
