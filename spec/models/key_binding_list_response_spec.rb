...
# Unit tests for Spatio::KeyBindingListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::KeyBindingListResponse do
  #let(:instance) { Spatio::KeyBindingListResponse.new }

  describe 'test an instance of KeyBindingListResponse' do
    it 'should create an instance of KeyBindingListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::KeyBindingListResponse)
    end
  end
