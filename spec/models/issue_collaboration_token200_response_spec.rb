...
# Unit tests for Spatio::IssueCollaborationToken200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::IssueCollaborationToken200Response do
  #let(:instance) { Spatio::IssueCollaborationToken200Response.new }

  describe 'test an instance of IssueCollaborationToken200Response' do
    it 'should create an instance of IssueCollaborationToken200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::IssueCollaborationToken200Response)
    end
  end
  ...
  describe 'test attribute "ws_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
