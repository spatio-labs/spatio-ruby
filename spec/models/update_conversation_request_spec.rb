...
# Unit tests for Spatio::UpdateConversationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateConversationRequest do
  #let(:instance) { Spatio::UpdateConversationRequest.new }

  describe 'test an instance of UpdateConversationRequest' do
    it 'should create an instance of UpdateConversationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateConversationRequest)
    end
  end
