...
# Unit tests for Spatio::BulkDeleteFilesRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteFilesRequest do
  #let(:instance) { Spatio::BulkDeleteFilesRequest.new }

  describe 'test an instance of BulkDeleteFilesRequest' do
    it 'should create an instance of BulkDeleteFilesRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteFilesRequest)
    end
  end
