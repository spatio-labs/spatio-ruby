...
# Unit tests for Spatio::ChannelMembershipRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChannelMembershipRequest do
  #let(:instance) { Spatio::ChannelMembershipRequest.new }

  describe 'test an instance of ChannelMembershipRequest' do
    it 'should create an instance of ChannelMembershipRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChannelMembershipRequest)
    end
  end
