...
# Unit tests for Spatio::CoreActionListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CoreActionListResponse do
  #let(:instance) { Spatio::CoreActionListResponse.new }

  describe 'test an instance of CoreActionListResponse' do
    it 'should create an instance of CoreActionListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CoreActionListResponse)
    end
  end
