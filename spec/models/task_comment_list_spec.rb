...
# Unit tests for Spatio::TaskCommentList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskCommentList do
  #let(:instance) { Spatio::TaskCommentList.new }

  describe 'test an instance of TaskCommentList' do
    it 'should create an instance of TaskCommentList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskCommentList)
    end
  end
