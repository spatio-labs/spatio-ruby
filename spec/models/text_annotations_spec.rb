...
# Unit tests for Spatio::TextAnnotations
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TextAnnotations do
  #let(:instance) { Spatio::TextAnnotations.new }

  describe 'test an instance of TextAnnotations' do
    it 'should create an instance of TextAnnotations' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TextAnnotations)
    end
  end
