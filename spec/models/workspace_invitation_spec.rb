...
# Unit tests for Spatio::WorkspaceInvitation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceInvitation do
  #let(:instance) { Spatio::WorkspaceInvitation.new }

  describe 'test an instance of WorkspaceInvitation' do
    it 'should create an instance of WorkspaceInvitation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceInvitation)
    end
  end
