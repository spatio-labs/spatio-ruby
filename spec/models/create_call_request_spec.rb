...
# Unit tests for Spatio::CreateCallRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateCallRequest do
  #let(:instance) { Spatio::CreateCallRequest.new }

  describe 'test an instance of CreateCallRequest' do
    it 'should create an instance of CreateCallRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateCallRequest)
    end
  end
