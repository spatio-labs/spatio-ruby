...
# Unit tests for Spatio::SendEmailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SendEmailResponse do
  #let(:instance) { Spatio::SendEmailResponse.new }

  describe 'test an instance of SendEmailResponse' do
    it 'should create an instance of SendEmailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SendEmailResponse)
    end
  end
