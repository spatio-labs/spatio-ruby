...
# Unit tests for Spatio::ChatActionDefinition
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChatActionDefinition do
  #let(:instance) { Spatio::ChatActionDefinition.new }

  describe 'test an instance of ChatActionDefinition' do
    it 'should create an instance of ChatActionDefinition' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChatActionDefinition)
    end
  end
