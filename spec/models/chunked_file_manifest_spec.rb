...
# Unit tests for Spatio::ChunkedFileManifest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChunkedFileManifest do
  #let(:instance) { Spatio::ChunkedFileManifest.new }

  describe 'test an instance of ChunkedFileManifest' do
    it 'should create an instance of ChunkedFileManifest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChunkedFileManifest)
    end
  end
  ...
  describe 'test attribute "chunking_algorithm"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "file_checksum"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
