...
# Unit tests for Spatio::WorkspaceInvitationListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceInvitationListResponse do
  #let(:instance) { Spatio::WorkspaceInvitationListResponse.new }

  describe 'test an instance of WorkspaceInvitationListResponse' do
    it 'should create an instance of WorkspaceInvitationListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceInvitationListResponse)
    end
  end
