...
# Unit tests for Spatio::RoutineRunCompleteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RoutineRunCompleteRequest do
  #let(:instance) { Spatio::RoutineRunCompleteRequest.new }

  describe 'test an instance of RoutineRunCompleteRequest' do
    it 'should create an instance of RoutineRunCompleteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RoutineRunCompleteRequest)
    end
  end
