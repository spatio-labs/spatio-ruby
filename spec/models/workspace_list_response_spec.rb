...
# Unit tests for Spatio::WorkspaceListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceListResponse do
  #let(:instance) { Spatio::WorkspaceListResponse.new }

  describe 'test an instance of WorkspaceListResponse' do
    it 'should create an instance of WorkspaceListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceListResponse)
    end
  end
