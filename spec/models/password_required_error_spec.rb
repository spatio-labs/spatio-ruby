...
# Unit tests for Spatio::PasswordRequiredError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PasswordRequiredError do
  #let(:instance) { Spatio::PasswordRequiredError.new }

  describe 'test an instance of PasswordRequiredError' do
    it 'should create an instance of PasswordRequiredError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PasswordRequiredError)
    end
  end
  ...
  describe 'test attribute "requires_password"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "invalid_password"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
