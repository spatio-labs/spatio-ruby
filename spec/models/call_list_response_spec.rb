...
# Unit tests for Spatio::CallListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CallListResponse do
  #let(:instance) { Spatio::CallListResponse.new }

  describe 'test an instance of CallListResponse' do
    it 'should create an instance of CallListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CallListResponse)
    end
  end
