...
# Unit tests for Spatio::CreateAppRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateAppRequest do
  #let(:instance) { Spatio::CreateAppRequest.new }

  describe 'test an instance of CreateAppRequest' do
    it 'should create an instance of CreateAppRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateAppRequest)
    end
  end
  ...
  describe 'test attribute "project_path"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
