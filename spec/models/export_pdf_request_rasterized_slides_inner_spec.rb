...
# Unit tests for Spatio::ExportPDFRequestRasterizedSlidesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExportPDFRequestRasterizedSlidesInner do
  #let(:instance) { Spatio::ExportPDFRequestRasterizedSlidesInner.new }

  describe 'test an instance of ExportPDFRequestRasterizedSlidesInner' do
    it 'should create an instance of ExportPDFRequestRasterizedSlidesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExportPDFRequestRasterizedSlidesInner)
    end
  end

  describe 'test attribute "slide_id"' do
    it 'should work' do
