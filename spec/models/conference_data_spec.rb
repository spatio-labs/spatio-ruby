...
# Unit tests for Spatio::ConferenceData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConferenceData do
  #let(:instance) { Spatio::ConferenceData.new }

  describe 'test an instance of ConferenceData' do
    it 'should create an instance of ConferenceData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConferenceData)
    end
  end
  ...
  describe 'test attribute "dial_in"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
