...
# Unit tests for Spatio::ExecuteActionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExecuteActionRequest do
  #let(:instance) { Spatio::ExecuteActionRequest.new }

  describe 'test an instance of ExecuteActionRequest' do
    it 'should create an instance of ExecuteActionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExecuteActionRequest)
    end
  end
