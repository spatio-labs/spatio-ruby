...
# Unit tests for Spatio::DMThreadReplyRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMThreadReplyRequest do
  #let(:instance) { Spatio::DMThreadReplyRequest.new }

  describe 'test an instance of DMThreadReplyRequest' do
    it 'should create an instance of DMThreadReplyRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMThreadReplyRequest)
    end
  end
