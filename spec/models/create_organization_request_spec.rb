...
# Unit tests for Spatio::CreateOrganizationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateOrganizationRequest do
  #let(:instance) { Spatio::CreateOrganizationRequest.new }
  ...
  describe 'test an instance of CreateOrganizationRequest' do
    it 'should create an instance of CreateOrganizationRequest' do
      ...
      #expect(instance).to be_instance_of(Spatio::CreateOrganizationRequest)
    end
  end
  ...
  describe 'test attribute "create_default_workspace"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "default_workspace_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
