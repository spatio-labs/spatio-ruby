...
# Unit tests for Spatio::UpdateRecommendationStatusRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateRecommendationStatusRequest do
  #let(:instance) { Spatio::UpdateRecommendationStatusRequest.new }

  describe 'test an instance of UpdateRecommendationStatusRequest' do
    it 'should create an instance of UpdateRecommendationStatusRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateRecommendationStatusRequest)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["accepted", "dismissed"])
