...
# Unit tests for Spatio::CreateFolderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateFolderRequest do
  #let(:instance) { Spatio::CreateFolderRequest.new }

  describe 'test an instance of CreateFolderRequest' do
    it 'should create an instance of CreateFolderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateFolderRequest)
    end
  end
