...
# Unit tests for Spatio::ShareSettings
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ShareSettings do
  #let(:instance) { Spatio::ShareSettings.new }

  describe 'test an instance of ShareSettings' do
    it 'should create an instance of ShareSettings' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ShareSettings)
    end
  end
  ...
  describe 'test attribute "password_set_at"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
