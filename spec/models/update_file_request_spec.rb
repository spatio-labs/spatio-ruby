...
# Unit tests for Spatio::UpdateFileRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateFileRequest do
  #let(:instance) { Spatio::UpdateFileRequest.new }

  describe 'test an instance of UpdateFileRequest' do
    it 'should create an instance of UpdateFileRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateFileRequest)
    end
  end
