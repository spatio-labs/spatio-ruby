...
# Unit tests for Spatio::BulkArchiveResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkArchiveResponse do
  #let(:instance) { Spatio::BulkArchiveResponse.new }

  describe 'test an instance of BulkArchiveResponse' do
    it 'should create an instance of BulkArchiveResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkArchiveResponse)
    end
  end
