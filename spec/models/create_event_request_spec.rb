...
# Unit tests for Spatio::CreateEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateEventRequest do
  #let(:instance) { Spatio::CreateEventRequest.new }

  describe 'test an instance of CreateEventRequest' do
    it 'should create an instance of CreateEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateEventRequest)
    end
  end
  ...
  describe 'test attribute "send_updates"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["all", "externalOnly", "none"])
      # validator.allowable_values.each do |value|
      #   expect { instance.send_updates = value }.not_to raise_error
      # end
    end
  end
