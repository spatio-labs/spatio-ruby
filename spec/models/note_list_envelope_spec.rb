...
# Unit tests for Spatio::NoteListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::NoteListEnvelope do
  #let(:instance) { Spatio::NoteListEnvelope.new }

  describe 'test an instance of NoteListEnvelope' do
    it 'should create an instance of NoteListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::NoteListEnvelope)
    end
  end
