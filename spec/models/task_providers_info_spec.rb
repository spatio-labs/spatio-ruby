...
# Unit tests for Spatio::TaskProvidersInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskProvidersInfo do
  #let(:instance) { Spatio::TaskProvidersInfo.new }

  describe 'test an instance of TaskProvidersInfo' do
    it 'should create an instance of TaskProvidersInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskProvidersInfo)
    end
  end
