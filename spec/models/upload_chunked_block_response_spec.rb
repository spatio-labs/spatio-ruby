...
# Unit tests for Spatio::UploadChunkedBlockResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UploadChunkedBlockResponse do
  #let(:instance) { Spatio::UploadChunkedBlockResponse.new }

  describe 'test an instance of UploadChunkedBlockResponse' do
    it 'should create an instance of UploadChunkedBlockResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UploadChunkedBlockResponse)
    end
  end
  ...
  describe 'test attribute "blocks_remaining"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
