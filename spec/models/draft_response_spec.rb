...
# Unit tests for Spatio::DraftResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DraftResponse do
  #let(:instance) { Spatio::DraftResponse.new }

  describe 'test an instance of DraftResponse' do
    it 'should create an instance of DraftResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DraftResponse)
    end
  end
