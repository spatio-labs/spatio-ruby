...
# Unit tests for Spatio::ProposeRecommendationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ProposeRecommendationRequest do
  #let(:instance) { Spatio::ProposeRecommendationRequest.new }

  describe 'test an instance of ProposeRecommendationRequest' do
    it 'should create an instance of ProposeRecommendationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ProposeRecommendationRequest)
    end
  end
