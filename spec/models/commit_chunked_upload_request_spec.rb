...
# Unit tests for Spatio::CommitChunkedUploadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CommitChunkedUploadRequest do
  #let(:instance) { Spatio::CommitChunkedUploadRequest.new }

  describe 'test an instance of CommitChunkedUploadRequest' do
    it 'should create an instance of CommitChunkedUploadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CommitChunkedUploadRequest)
    end
  end
