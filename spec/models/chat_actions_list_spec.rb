...
# Unit tests for Spatio::ChatActionsList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChatActionsList do
  #let(:instance) { Spatio::ChatActionsList.new }

  describe 'test an instance of ChatActionsList' do
    it 'should create an instance of ChatActionsList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChatActionsList)
    end
  end
