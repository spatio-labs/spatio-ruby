...
# Unit tests for Spatio::UpdateAgentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateAgentRequest do
  #let(:instance) { Spatio::UpdateAgentRequest.new }

  describe 'test an instance of UpdateAgentRequest' do
    it 'should create an instance of UpdateAgentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateAgentRequest)
    end
  end
