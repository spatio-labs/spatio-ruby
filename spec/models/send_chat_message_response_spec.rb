...
# Unit tests for Spatio::SendChatMessageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SendChatMessageResponse do
  #let(:instance) { Spatio::SendChatMessageResponse.new }

  describe 'test an instance of SendChatMessageResponse' do
    it 'should create an instance of SendChatMessageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SendChatMessageResponse)
    end
  end
