...
# Unit tests for Spatio::WorkspaceOrganization
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceOrganization do
  #let(:instance) { Spatio::WorkspaceOrganization.new }

  describe 'test an instance of WorkspaceOrganization' do
    it 'should create an instance of WorkspaceOrganization' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceOrganization)
    end
  end
