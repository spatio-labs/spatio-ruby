...
# Unit tests for Spatio::BulkDeleteTasksResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteTasksResponse do
  #let(:instance) { Spatio::BulkDeleteTasksResponse.new }

  describe 'test an instance of BulkDeleteTasksResponse' do
    it 'should create an instance of BulkDeleteTasksResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteTasksResponse)
    end
  end
