...
# Unit tests for Spatio::UpdateCommentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateCommentRequest do
  #let(:instance) { Spatio::UpdateCommentRequest.new }

  describe 'test an instance of UpdateCommentRequest' do
    it 'should create an instance of UpdateCommentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateCommentRequest)
    end
  end
