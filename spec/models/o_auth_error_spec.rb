...
# Unit tests for Spatio::OAuthError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OAuthError do
  #let(:instance) { Spatio::OAuthError.new }

  describe 'test an instance of OAuthError' do
    it 'should create an instance of OAuthError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OAuthError)
    end
  end
  ...
  describe 'test attribute "error"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["invalid_request", "invalid_client", "invalid_grant", "unauthorized_client", "unsupported_grant_type", "unsupported_response_type", "invalid_scope", "access_denied", "server_error", "temporarily_unavailable", "invalid_token", "invalid_redirect_uri", "invalid_client_metadata", "login_required", "consent_required", "interaction_required", "rate_limit_exceeded"])
