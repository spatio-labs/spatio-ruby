...
# Unit tests for Spatio::ContactCategoryListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ContactCategoryListResponse do
  #let(:instance) { Spatio::ContactCategoryListResponse.new }

  describe 'test an instance of ContactCategoryListResponse' do
    it 'should create an instance of ContactCategoryListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ContactCategoryListResponse)
    end
  end
