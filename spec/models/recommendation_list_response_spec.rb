...
# Unit tests for Spatio::RecommendationListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RecommendationListResponse do
  #let(:instance) { Spatio::RecommendationListResponse.new }

  describe 'test an instance of RecommendationListResponse' do
    it 'should create an instance of RecommendationListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RecommendationListResponse)
    end
  end
