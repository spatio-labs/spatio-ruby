...
# Unit tests for Spatio::AppListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AppListResponse do
  #let(:instance) { Spatio::AppListResponse.new }

  describe 'test an instance of AppListResponse' do
    it 'should create an instance of AppListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AppListResponse)
    end
  end
