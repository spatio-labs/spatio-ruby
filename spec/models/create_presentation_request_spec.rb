...
# Unit tests for Spatio::CreatePresentationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreatePresentationRequest do
  #let(:instance) { Spatio::CreatePresentationRequest.new }

  describe 'test an instance of CreatePresentationRequest' do
    it 'should create an instance of CreatePresentationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreatePresentationRequest)
    end
  end
