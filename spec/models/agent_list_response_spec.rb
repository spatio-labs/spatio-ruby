...
# Unit tests for Spatio::AgentListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentListResponse do
  #let(:instance) { Spatio::AgentListResponse.new }

  describe 'test an instance of AgentListResponse' do
    it 'should create an instance of AgentListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentListResponse)
    end
  end
