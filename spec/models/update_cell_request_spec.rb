...
# Unit tests for Spatio::UpdateCellRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateCellRequest do
  #let(:instance) { Spatio::UpdateCellRequest.new }

  describe 'test an instance of UpdateCellRequest' do
    it 'should create an instance of UpdateCellRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateCellRequest)
    end
  end
