...
# Unit tests for Spatio::CreateRecordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateRecordRequest do
  #let(:instance) { Spatio::CreateRecordRequest.new }

  describe 'test an instance of CreateRecordRequest' do
    it 'should create an instance of CreateRecordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateRecordRequest)
    end
  end
  ...
  describe 'test attribute "record_type_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
