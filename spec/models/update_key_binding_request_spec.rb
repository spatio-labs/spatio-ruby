...
# Unit tests for Spatio::UpdateKeyBindingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateKeyBindingRequest do
  #let(:instance) { Spatio::UpdateKeyBindingRequest.new }

  describe 'test an instance of UpdateKeyBindingRequest' do
    it 'should create an instance of UpdateKeyBindingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateKeyBindingRequest)
    end
  end
