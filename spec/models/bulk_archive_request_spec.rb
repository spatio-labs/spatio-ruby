...
# Unit tests for Spatio::BulkArchiveRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkArchiveRequest do
  #let(:instance) { Spatio::BulkArchiveRequest.new }

  describe 'test an instance of BulkArchiveRequest' do
    it 'should create an instance of BulkArchiveRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkArchiveRequest)
    end
  end
