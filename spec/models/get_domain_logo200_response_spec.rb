...
# Unit tests for Spatio::GetDomainLogo200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::GetDomainLogo200Response do
  #let(:instance) { Spatio::GetDomainLogo200Response.new }

  describe 'test an instance of GetDomainLogo200Response' do
    it 'should create an instance of GetDomainLogo200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::GetDomainLogo200Response)
    end
  end
