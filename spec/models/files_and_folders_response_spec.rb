...
# Unit tests for Spatio::FilesAndFoldersResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FilesAndFoldersResponse do
  #let(:instance) { Spatio::FilesAndFoldersResponse.new }

  describe 'test an instance of FilesAndFoldersResponse' do
    it 'should create an instance of FilesAndFoldersResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FilesAndFoldersResponse)
    end
  end
