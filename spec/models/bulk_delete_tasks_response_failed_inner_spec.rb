...
# Unit tests for Spatio::BulkDeleteTasksResponseFailedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteTasksResponseFailedInner do
  #let(:instance) { Spatio::BulkDeleteTasksResponseFailedInner.new }

  describe 'test an instance of BulkDeleteTasksResponseFailedInner' do
    it 'should create an instance of BulkDeleteTasksResponseFailedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteTasksResponseFailedInner)
    end
  end
