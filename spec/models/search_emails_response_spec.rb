...
# Unit tests for Spatio::SearchEmailsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SearchEmailsResponse do
  #let(:instance) { Spatio::SearchEmailsResponse.new }

  describe 'test an instance of SearchEmailsResponse' do
    it 'should create an instance of SearchEmailsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SearchEmailsResponse)
    end
  end
