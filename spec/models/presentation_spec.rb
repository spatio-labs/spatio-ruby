...
# Unit tests for Spatio::Presentation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Presentation do
  #let(:instance) { Spatio::Presentation.new }

  describe 'test an instance of Presentation' do
    it 'should create an instance of Presentation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Presentation)
    end
  end
