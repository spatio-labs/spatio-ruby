...
# Unit tests for Spatio::ValidateKeyBindingRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ValidateKeyBindingRequest do
  #let(:instance) { Spatio::ValidateKeyBindingRequest.new }

  describe 'test an instance of ValidateKeyBindingRequest' do
    it 'should create an instance of ValidateKeyBindingRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ValidateKeyBindingRequest)
    end
  end
