...
# Unit tests for Spatio::ContactListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ContactListResponse do
  #let(:instance) { Spatio::ContactListResponse.new }

  describe 'test an instance of ContactListResponse' do
    it 'should create an instance of ContactListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ContactListResponse)
    end
  end
