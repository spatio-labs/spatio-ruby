...
# Unit tests for Spatio::UpdateEventRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateEventRequest do
  #let(:instance) { Spatio::UpdateEventRequest.new }

  describe 'test an instance of UpdateEventRequest' do
    it 'should create an instance of UpdateEventRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateEventRequest)
    end
  end
