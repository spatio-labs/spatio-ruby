...
# Unit tests for Spatio::SpatioConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SpatioConnection do
  #let(:instance) { Spatio::SpatioConnection.new }

  describe 'test an instance of SpatioConnection' do
    it 'should create an instance of SpatioConnection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SpatioConnection)
    end
  end
  ...
  describe 'test attribute "gradient_from"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "gradient_to"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
