...
# Unit tests for Spatio::Attendee
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Attendee do
  #let(:instance) { Spatio::Attendee.new }

  describe 'test an instance of Attendee' do
    it 'should create an instance of Attendee' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Attendee)
    end
  end
  ...
  describe 'test attribute "additional_guests"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
