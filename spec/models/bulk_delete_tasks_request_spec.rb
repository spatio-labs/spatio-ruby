...
# Unit tests for Spatio::BulkDeleteTasksRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteTasksRequest do
  #let(:instance) { Spatio::BulkDeleteTasksRequest.new }

  describe 'test an instance of BulkDeleteTasksRequest' do
    it 'should create an instance of BulkDeleteTasksRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteTasksRequest)
    end
  end
