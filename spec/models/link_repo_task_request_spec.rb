...
# Unit tests for Spatio::LinkRepoTaskRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::LinkRepoTaskRequest do
  #let(:instance) { Spatio::LinkRepoTaskRequest.new }

  describe 'test an instance of LinkRepoTaskRequest' do
    it 'should create an instance of LinkRepoTaskRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::LinkRepoTaskRequest)
    end
  end
