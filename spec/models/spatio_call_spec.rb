...
# Unit tests for Spatio::SpatioCall
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SpatioCall do
  #let(:instance) { Spatio::SpatioCall.new }

  describe 'test an instance of SpatioCall' do
    it 'should create an instance of SpatioCall' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SpatioCall)
    end
  end
  ...
  describe 'test attribute "host_user_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
