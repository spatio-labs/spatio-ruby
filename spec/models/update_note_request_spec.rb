...
# Unit tests for Spatio::UpdateNoteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateNoteRequest do
  #let(:instance) { Spatio::UpdateNoteRequest.new }

  describe 'test an instance of UpdateNoteRequest' do
    it 'should create an instance of UpdateNoteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateNoteRequest)
    end
  end
