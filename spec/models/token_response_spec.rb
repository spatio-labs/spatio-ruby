...
# Unit tests for Spatio::TokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TokenResponse do
  #let(:instance) { Spatio::TokenResponse.new }

  describe 'test an instance of TokenResponse' do
    it 'should create an instance of TokenResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TokenResponse)
    end
  end
