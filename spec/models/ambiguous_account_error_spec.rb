...
# Unit tests for Spatio::AmbiguousAccountError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AmbiguousAccountError do
  #let(:instance) { Spatio::AmbiguousAccountError.new }

  describe 'test an instance of AmbiguousAccountError' do
    it 'should create an instance of AmbiguousAccountError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AmbiguousAccountError)
    end
  end
