...
# Unit tests for Spatio::UpdateWorkspaceMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateWorkspaceMemberRequest do
  #let(:instance) { Spatio::UpdateWorkspaceMemberRequest.new }

  describe 'test an instance of UpdateWorkspaceMemberRequest' do
    it 'should create an instance of UpdateWorkspaceMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateWorkspaceMemberRequest)
    end
  end
