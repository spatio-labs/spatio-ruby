...
# Unit tests for Spatio::OrganizationMemberListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationMemberListResponse do
  #let(:instance) { Spatio::OrganizationMemberListResponse.new }

  describe 'test an instance of OrganizationMemberListResponse' do
    it 'should create an instance of OrganizationMemberListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OrganizationMemberListResponse)
    end
  end
