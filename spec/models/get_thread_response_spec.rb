...
# Unit tests for Spatio::GetThreadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::GetThreadResponse do
  #let(:instance) { Spatio::GetThreadResponse.new }

  describe 'test an instance of GetThreadResponse' do
    it 'should create an instance of GetThreadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::GetThreadResponse)
    end
  end
