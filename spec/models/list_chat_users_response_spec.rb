...
# Unit tests for Spatio::ListChatUsersResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListChatUsersResponse do
  #let(:instance) { Spatio::ListChatUsersResponse.new }

  describe 'test an instance of ListChatUsersResponse' do
    it 'should create an instance of ListChatUsersResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListChatUsersResponse)
    end
  end
