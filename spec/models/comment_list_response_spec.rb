...
# Unit tests for Spatio::CommentListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CommentListResponse do
  #let(:instance) { Spatio::CommentListResponse.new }

  describe 'test an instance of CommentListResponse' do
    it 'should create an instance of CommentListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CommentListResponse)
    end
  end
