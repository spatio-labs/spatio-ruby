...
# Unit tests for Spatio::UpdateSheetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateSheetRequest do
  #let(:instance) { Spatio::UpdateSheetRequest.new }

  describe 'test an instance of UpdateSheetRequest' do
    it 'should create an instance of UpdateSheetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateSheetRequest)
    end
  end
