...
# Unit tests for Spatio::AccountChoice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AccountChoice do
  #let(:instance) { Spatio::AccountChoice.new }

  describe 'test an instance of AccountChoice' do
    it 'should create an instance of AccountChoice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AccountChoice)
    end
  end
