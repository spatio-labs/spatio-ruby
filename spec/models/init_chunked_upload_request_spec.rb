...
# Unit tests for Spatio::InitChunkedUploadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InitChunkedUploadRequest do
  #let(:instance) { Spatio::InitChunkedUploadRequest.new }

  describe 'test an instance of InitChunkedUploadRequest' do
    it 'should create an instance of InitChunkedUploadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InitChunkedUploadRequest)
    end
  end
  ...
  describe 'test attribute "expected_blocks"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
