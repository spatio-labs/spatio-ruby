...
# Unit tests for Spatio::AgentMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentMessage do
  #let(:instance) { Spatio::AgentMessage.new }

  describe 'test an instance of AgentMessage' do
    it 'should create an instance of AgentMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentMessage)
    end
  end
