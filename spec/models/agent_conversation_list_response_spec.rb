...
# Unit tests for Spatio::AgentConversationListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentConversationListResponse do
  #let(:instance) { Spatio::AgentConversationListResponse.new }

  describe 'test an instance of AgentConversationListResponse' do
    it 'should create an instance of AgentConversationListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentConversationListResponse)
    end
  end
