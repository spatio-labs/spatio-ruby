...
# Unit tests for Spatio::ConnectionAccountListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConnectionAccountListResponse do
  #let(:instance) { Spatio::ConnectionAccountListResponse.new }

  describe 'test an instance of ConnectionAccountListResponse' do
    it 'should create an instance of ConnectionAccountListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConnectionAccountListResponse)
    end
  end
