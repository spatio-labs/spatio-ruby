...
# Unit tests for Spatio::SearchFilesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SearchFilesResponse do
  #let(:instance) { Spatio::SearchFilesResponse.new }

  describe 'test an instance of SearchFilesResponse' do
    it 'should create an instance of SearchFilesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SearchFilesResponse)
    end
  end
