...
# Unit tests for Spatio::AccountPlan
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AccountPlan do
  #let(:instance) { Spatio::AccountPlan.new }

  describe 'test an instance of AccountPlan' do
    it 'should create an instance of AccountPlan' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AccountPlan)
    end
  end
