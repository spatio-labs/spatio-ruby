...
# Unit tests for Spatio::DMPinnedList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMPinnedList do
  #let(:instance) { Spatio::DMPinnedList.new }

  describe 'test an instance of DMPinnedList' do
    it 'should create an instance of DMPinnedList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMPinnedList)
    end
  end
