...
# Unit tests for Spatio::ActionDescriptor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ActionDescriptor do
  #let(:instance) { Spatio::ActionDescriptor.new }

  describe 'test an instance of ActionDescriptor' do
    it 'should create an instance of ActionDescriptor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ActionDescriptor)
    end
  end
