...
# Unit tests for Spatio::BulkMarkReadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkMarkReadRequest do
  #let(:instance) { Spatio::BulkMarkReadRequest.new }

  describe 'test an instance of BulkMarkReadRequest' do
    it 'should create an instance of BulkMarkReadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkMarkReadRequest)
    end
  end
