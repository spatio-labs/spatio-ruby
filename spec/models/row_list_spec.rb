...
# Unit tests for Spatio::RowList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RowList do
  #let(:instance) { Spatio::RowList.new }

  describe 'test an instance of RowList' do
    it 'should create an instance of RowList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RowList)
    end
  end
