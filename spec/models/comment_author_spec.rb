...
# Unit tests for Spatio::CommentAuthor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CommentAuthor do
  #let(:instance) { Spatio::CommentAuthor.new }

  describe 'test an instance of CommentAuthor' do
    it 'should create an instance of CommentAuthor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CommentAuthor)
    end
  end
