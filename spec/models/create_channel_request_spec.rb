...
# Unit tests for Spatio::CreateChannelRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateChannelRequest do
  #let(:instance) { Spatio::CreateChannelRequest.new }

  describe 'test an instance of CreateChannelRequest' do
    it 'should create an instance of CreateChannelRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateChannelRequest)
    end
  end
