...
# Unit tests for Spatio::MeetingRoom
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::MeetingRoom do
  #let(:instance) { Spatio::MeetingRoom.new }

  describe 'test an instance of MeetingRoom' do
    it 'should create an instance of MeetingRoom' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::MeetingRoom)
    end
  end
