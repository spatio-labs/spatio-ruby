...
# Unit tests for Spatio::DMAttachRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMAttachRequest do
  #let(:instance) { Spatio::DMAttachRequest.new }

  describe 'test an instance of DMAttachRequest' do
    it 'should create an instance of DMAttachRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMAttachRequest)
    end
  end
