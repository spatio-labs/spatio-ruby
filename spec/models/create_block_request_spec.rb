...
# Unit tests for Spatio::CreateBlockRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateBlockRequest do
  #let(:instance) { Spatio::CreateBlockRequest.new }

  describe 'test an instance of CreateBlockRequest' do
    it 'should create an instance of CreateBlockRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateBlockRequest)
    end
  end
