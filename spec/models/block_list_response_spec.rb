...
# Unit tests for Spatio::BlockListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BlockListResponse do
  #let(:instance) { Spatio::BlockListResponse.new }

  describe 'test an instance of BlockListResponse' do
    it 'should create an instance of BlockListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BlockListResponse)
    end
  end
