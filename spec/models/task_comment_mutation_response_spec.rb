...
# Unit tests for Spatio::TaskCommentMutationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskCommentMutationResponse do
  #let(:instance) { Spatio::TaskCommentMutationResponse.new }

  describe 'test an instance of TaskCommentMutationResponse' do
    it 'should create an instance of TaskCommentMutationResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskCommentMutationResponse)
    end
  end
