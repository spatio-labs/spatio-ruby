...
# Unit tests for Spatio::CommentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CommentResponse do
  #let(:instance) { Spatio::CommentResponse.new }

  describe 'test an instance of CommentResponse' do
    it 'should create an instance of CommentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CommentResponse)
    end
  end
