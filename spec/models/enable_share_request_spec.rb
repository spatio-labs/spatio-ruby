...
# Unit tests for Spatio::EnableShareRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::EnableShareRequest do
  #let(:instance) { Spatio::EnableShareRequest.new }

  describe 'test an instance of EnableShareRequest' do
    it 'should create an instance of EnableShareRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::EnableShareRequest)
    end
  end

  describe 'test attribute "set_password"' do
    it 'should work' do
