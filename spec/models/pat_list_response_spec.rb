...
# Unit tests for Spatio::PATListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PATListResponse do
  #let(:instance) { Spatio::PATListResponse.new }

  describe 'test an instance of PATListResponse' do
    it 'should create an instance of PATListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PATListResponse)
    end
  end
  ...
  describe 'test attribute "available_scopes"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
