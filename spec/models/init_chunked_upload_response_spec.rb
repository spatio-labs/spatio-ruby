...
# Unit tests for Spatio::InitChunkedUploadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InitChunkedUploadResponse do
  #let(:instance) { Spatio::InitChunkedUploadResponse.new }

  describe 'test an instance of InitChunkedUploadResponse' do
    it 'should create an instance of InitChunkedUploadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InitChunkedUploadResponse)
    end
  end
  ...
  describe 'test attribute "blocks_to_upload"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "blocks_already_exist"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "estimated_upload_size"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
