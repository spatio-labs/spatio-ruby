...
# Unit tests for Spatio::SendChatMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SendChatMessageRequest do
  #let(:instance) { Spatio::SendChatMessageRequest.new }

  describe 'test an instance of SendChatMessageRequest' do
    it 'should create an instance of SendChatMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SendChatMessageRequest)
    end
  end
