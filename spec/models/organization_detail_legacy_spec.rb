...
# Unit tests for Spatio::OrganizationDetailLegacy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationDetailLegacy do
  #let(:instance) { Spatio::OrganizationDetailLegacy.new }

  describe 'test an instance of OrganizationDetailLegacy' do
    it 'should create an instance of OrganizationDetailLegacy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OrganizationDetailLegacy)
    end
  end
