...
# Unit tests for Spatio::CalendarProviderInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarProviderInfo do
  #let(:instance) { Spatio::CalendarProviderInfo.new }

  describe 'test an instance of CalendarProviderInfo' do
    it 'should create an instance of CalendarProviderInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarProviderInfo)
    end
  end
