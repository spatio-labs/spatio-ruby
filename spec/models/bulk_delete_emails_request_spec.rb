...
# Unit tests for Spatio::BulkDeleteEmailsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkDeleteEmailsRequest do
  #let(:instance) { Spatio::BulkDeleteEmailsRequest.new }

  describe 'test an instance of BulkDeleteEmailsRequest' do
    it 'should create an instance of BulkDeleteEmailsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkDeleteEmailsRequest)
    end
  end
