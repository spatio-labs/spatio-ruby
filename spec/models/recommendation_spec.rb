...
# Unit tests for Spatio::Recommendation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Recommendation do
  #let(:instance) { Spatio::Recommendation.new }

  describe 'test an instance of Recommendation' do
    it 'should create an instance of Recommendation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Recommendation)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "accepted", "dismissed", "expired"])
