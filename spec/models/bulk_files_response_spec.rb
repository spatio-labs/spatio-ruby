...
# Unit tests for Spatio::BulkFilesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkFilesResponse do
  #let(:instance) { Spatio::BulkFilesResponse.new }

  describe 'test an instance of BulkFilesResponse' do
    it 'should create an instance of BulkFilesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkFilesResponse)
    end
  end
