...
# Unit tests for Spatio::CreatePATResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreatePATResponse do
  #let(:instance) { Spatio::CreatePATResponse.new }

  describe 'test an instance of CreatePATResponse' do
    it 'should create an instance of CreatePATResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreatePATResponse)
    end
  end
  ...
  describe 'test attribute "pat"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
