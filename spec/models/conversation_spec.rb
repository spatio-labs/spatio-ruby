...
# Unit tests for Spatio::Conversation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Conversation do
  #let(:instance) { Spatio::Conversation.new }

  describe 'test an instance of Conversation' do
    it 'should create an instance of Conversation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Conversation)
    end
  end
