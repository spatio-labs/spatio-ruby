...
# Unit tests for Spatio::DMSetDraftRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMSetDraftRequest do
  #let(:instance) { Spatio::DMSetDraftRequest.new }

  describe 'test an instance of DMSetDraftRequest' do
    it 'should create an instance of DMSetDraftRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMSetDraftRequest)
    end
  end
