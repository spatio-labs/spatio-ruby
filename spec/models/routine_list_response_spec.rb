...
# Unit tests for Spatio::RoutineListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RoutineListResponse do
  #let(:instance) { Spatio::RoutineListResponse.new }

  describe 'test an instance of RoutineListResponse' do
    it 'should create an instance of RoutineListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RoutineListResponse)
    end
  end
