...
# Unit tests for Spatio::Agent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Agent do
  #let(:instance) { Spatio::Agent.new }

  describe 'test an instance of Agent' do
    it 'should create an instance of Agent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Agent)
    end
  end
  ...
  describe 'test attribute "is_preconfigured"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
