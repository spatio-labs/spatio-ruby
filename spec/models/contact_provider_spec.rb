...
# Unit tests for Spatio::ContactProvider
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ContactProvider do
  #let(:instance) { Spatio::ContactProvider.new }

  describe 'test an instance of ContactProvider' do
    it 'should create an instance of ContactProvider' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ContactProvider)
    end
  end
