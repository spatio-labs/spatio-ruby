...
# Unit tests for Spatio::CalendarAccountError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarAccountError do
  #let(:instance) { Spatio::CalendarAccountError.new }

  describe 'test an instance of CalendarAccountError' do
    it 'should create an instance of CalendarAccountError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarAccountError)
    end
  end
