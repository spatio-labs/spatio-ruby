...
# Unit tests for Spatio::CreateCommentRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateCommentRequest do
  #let(:instance) { Spatio::CreateCommentRequest.new }

  describe 'test an instance of CreateCommentRequest' do
    it 'should create an instance of CreateCommentRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateCommentRequest)
    end
  end
