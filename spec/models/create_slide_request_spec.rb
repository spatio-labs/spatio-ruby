...
# Unit tests for Spatio::CreateSlideRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateSlideRequest do
  #let(:instance) { Spatio::CreateSlideRequest.new }

  describe 'test an instance of CreateSlideRequest' do
    it 'should create an instance of CreateSlideRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateSlideRequest)
    end
  end
