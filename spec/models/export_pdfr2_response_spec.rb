...
# Unit tests for Spatio::ExportPDFR2Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ExportPDFR2Response do
  #let(:instance) { Spatio::ExportPDFR2Response.new }

  describe 'test an instance of ExportPDFR2Response' do
    it 'should create an instance of ExportPDFR2Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ExportPDFR2Response)
    end
  end
  ...
  describe 'test attribute "storage"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["r2"])
