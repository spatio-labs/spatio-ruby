...
# Unit tests for Spatio::RecordListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RecordListResponse do
  #let(:instance) { Spatio::RecordListResponse.new }

  describe 'test an instance of RecordListResponse' do
    it 'should create an instance of RecordListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RecordListResponse)
    end
  end
