...
# Unit tests for Spatio::MoveBlockRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::MoveBlockRequest do
  #let(:instance) { Spatio::MoveBlockRequest.new }

  describe 'test an instance of MoveBlockRequest' do
    it 'should create an instance of MoveBlockRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::MoveBlockRequest)
    end
  end
