...
# Unit tests for Spatio::JWK
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::JWK do
  #let(:instance) { Spatio::JWK.new }

  describe 'test an instance of JWK' do
    it 'should create an instance of JWK' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::JWK)
    end
  end
