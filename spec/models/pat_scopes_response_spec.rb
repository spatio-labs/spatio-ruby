...
# Unit tests for Spatio::PATScopesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PATScopesResponse do
  #let(:instance) { Spatio::PATScopesResponse.new }

  describe 'test an instance of PATScopesResponse' do
    it 'should create an instance of PATScopesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PATScopesResponse)
    end
  end
