...
# Unit tests for Spatio::UpdateBlockRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateBlockRequest do
  #let(:instance) { Spatio::UpdateBlockRequest.new }

  describe 'test an instance of UpdateBlockRequest' do
    it 'should create an instance of UpdateBlockRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateBlockRequest)
    end
  end
