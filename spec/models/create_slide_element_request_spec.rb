...
# Unit tests for Spatio::CreateSlideElementRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateSlideElementRequest do
  #let(:instance) { Spatio::CreateSlideElementRequest.new }

  describe 'test an instance of CreateSlideElementRequest' do
    it 'should create an instance of CreateSlideElementRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateSlideElementRequest)
    end
  end
