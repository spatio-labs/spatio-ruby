...
# Unit tests for Spatio::CreateOrganizationInvitationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateOrganizationInvitationRequest do
  #let(:instance) { Spatio::CreateOrganizationInvitationRequest.new }
  ...
  describe 'test an instance of CreateOrganizationInvitationRequest' do
    it 'should create an instance of CreateOrganizationInvitationRequest' do
      ...
      #expect(instance).to be_instance_of(Spatio::CreateOrganizationInvitationRequest)
    end
  end
