...
# Unit tests for Spatio::UpdateRecordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateRecordRequest do
  #let(:instance) { Spatio::UpdateRecordRequest.new }

  describe 'test an instance of UpdateRecordRequest' do
    it 'should create an instance of UpdateRecordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateRecordRequest)
    end
  end
