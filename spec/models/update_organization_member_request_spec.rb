...
# Unit tests for Spatio::UpdateOrganizationMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateOrganizationMemberRequest do
  #let(:instance) { Spatio::UpdateOrganizationMemberRequest.new }

  describe 'test an instance of UpdateOrganizationMemberRequest' do
    it 'should create an instance of UpdateOrganizationMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateOrganizationMemberRequest)
    end
  end
  ...
  describe 'test attribute "role"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["owner", "admin", "billing_admin", "member"])
