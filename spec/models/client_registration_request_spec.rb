...
# Unit tests for Spatio::ClientRegistrationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ClientRegistrationRequest do
  #let(:instance) { Spatio::ClientRegistrationRequest.new }

  describe 'test an instance of ClientRegistrationRequest' do
    it 'should create an instance of ClientRegistrationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ClientRegistrationRequest)
    end
  end
  ...
  describe 'test attribute "token_endpoint_auth_method"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["none", "client_secret_basic", "client_secret_post"])
      # validator.allowable_values.each do |value|
      #   expect { instance.token_endpoint_auth_method = value }.not_to raise_error
      # end
    end
  end
