...
# Unit tests for Spatio::SignInMethods
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SignInMethods do
  #let(:instance) { Spatio::SignInMethods.new }

  describe 'test an instance of SignInMethods' do
    it 'should create an instance of SignInMethods' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SignInMethods)
    end
  end
