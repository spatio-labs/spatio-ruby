...
# Unit tests for Spatio::UpdateContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateContactRequest do
  #let(:instance) { Spatio::UpdateContactRequest.new }

  describe 'test an instance of UpdateContactRequest' do
    it 'should create an instance of UpdateContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateContactRequest)
    end
  end
