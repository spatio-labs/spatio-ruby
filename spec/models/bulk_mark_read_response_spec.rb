...
# Unit tests for Spatio::BulkMarkReadResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkMarkReadResponse do
  #let(:instance) { Spatio::BulkMarkReadResponse.new }

  describe 'test an instance of BulkMarkReadResponse' do
    it 'should create an instance of BulkMarkReadResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkMarkReadResponse)
    end
  end
