...
# Unit tests for Spatio::AccountError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AccountError do
  #let(:instance) { Spatio::AccountError.new }

  describe 'test an instance of AccountError' do
    it 'should create an instance of AccountError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AccountError)
    end
  end
