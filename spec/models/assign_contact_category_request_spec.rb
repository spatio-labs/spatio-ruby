...
# Unit tests for Spatio::AssignContactCategoryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AssignContactCategoryRequest do
  #let(:instance) { Spatio::AssignContactCategoryRequest.new }

  describe 'test an instance of AssignContactCategoryRequest' do
    it 'should create an instance of AssignContactCategoryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AssignContactCategoryRequest)
    end
  end
