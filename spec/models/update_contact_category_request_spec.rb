...
# Unit tests for Spatio::UpdateContactCategoryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateContactCategoryRequest do
  #let(:instance) { Spatio::UpdateContactCategoryRequest.new }

  describe 'test an instance of UpdateContactCategoryRequest' do
    it 'should create an instance of UpdateContactCategoryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateContactCategoryRequest)
    end
  end
