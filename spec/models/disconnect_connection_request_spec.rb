...
# Unit tests for Spatio::DisconnectConnectionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DisconnectConnectionRequest do
  #let(:instance) { Spatio::DisconnectConnectionRequest.new }

  describe 'test an instance of DisconnectConnectionRequest' do
    it 'should create an instance of DisconnectConnectionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DisconnectConnectionRequest)
    end
  end
