...
# Unit tests for Spatio::OrganizationWorkspacesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationWorkspacesInner do
  #let(:instance) { Spatio::OrganizationWorkspacesInner.new }

  describe 'test an instance of OrganizationWorkspacesInner' do
    it 'should create an instance of OrganizationWorkspacesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OrganizationWorkspacesInner)
    end
  end
