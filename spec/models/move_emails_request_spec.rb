...
# Unit tests for Spatio::MoveEmailsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::MoveEmailsRequest do
  #let(:instance) { Spatio::MoveEmailsRequest.new }

  describe 'test an instance of MoveEmailsRequest' do
    it 'should create an instance of MoveEmailsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::MoveEmailsRequest)
    end
  end
