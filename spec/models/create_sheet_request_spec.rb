...
# Unit tests for Spatio::CreateSheetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateSheetRequest do
  #let(:instance) { Spatio::CreateSheetRequest.new }

  describe 'test an instance of CreateSheetRequest' do
    it 'should create an instance of CreateSheetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateSheetRequest)
    end
  end
