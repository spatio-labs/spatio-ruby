...
# Unit tests for Spatio::PersonalAccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PersonalAccessToken do
  #let(:instance) { Spatio::PersonalAccessToken.new }

  describe 'test an instance of PersonalAccessToken' do
    it 'should create an instance of PersonalAccessToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PersonalAccessToken)
    end
  end
