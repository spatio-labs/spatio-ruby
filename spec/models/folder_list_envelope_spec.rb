...
# Unit tests for Spatio::FolderListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::FolderListEnvelope do
  #let(:instance) { Spatio::FolderListEnvelope.new }

  describe 'test an instance of FolderListEnvelope' do
    it 'should create an instance of FolderListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::FolderListEnvelope)
    end
  end
