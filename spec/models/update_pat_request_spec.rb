...
# Unit tests for Spatio::UpdatePATRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdatePATRequest do
  #let(:instance) { Spatio::UpdatePATRequest.new }

  describe 'test an instance of UpdatePATRequest' do
    it 'should create an instance of UpdatePATRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdatePATRequest)
    end
  end
