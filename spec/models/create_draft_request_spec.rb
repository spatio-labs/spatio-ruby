...
# Unit tests for Spatio::CreateDraftRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateDraftRequest do
  #let(:instance) { Spatio::CreateDraftRequest.new }

  describe 'test an instance of CreateDraftRequest' do
    it 'should create an instance of CreateDraftRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateDraftRequest)
    end
  end
