...
# Unit tests for Spatio::SessionListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SessionListResponse do
  #let(:instance) { Spatio::SessionListResponse.new }

  describe 'test an instance of SessionListResponse' do
    it 'should create an instance of SessionListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SessionListResponse)
    end
  end
