...
# Unit tests for Spatio::PublicInvitationPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PublicInvitationPayload do
  #let(:instance) { Spatio::PublicInvitationPayload.new }

  describe 'test an instance of PublicInvitationPayload' do
    it 'should create an instance of PublicInvitationPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PublicInvitationPayload)
    end
  end
  ...
  describe 'test attribute "kind"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["workspace", "organization"])
