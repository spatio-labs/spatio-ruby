...
# Unit tests for Spatio::PresentationListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::PresentationListEnvelope do
  #let(:instance) { Spatio::PresentationListEnvelope.new }

  describe 'test an instance of PresentationListEnvelope' do
    it 'should create an instance of PresentationListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::PresentationListEnvelope)
    end
  end
