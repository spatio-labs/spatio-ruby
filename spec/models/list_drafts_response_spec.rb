...
# Unit tests for Spatio::ListDraftsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListDraftsResponse do
  #let(:instance) { Spatio::ListDraftsResponse.new }

  describe 'test an instance of ListDraftsResponse' do
    it 'should create an instance of ListDraftsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListDraftsResponse)
    end
  end

  describe 'test attribute "drafts"' do
    it 'should work' do
