...
# Unit tests for Spatio::UpdateRecordTypeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateRecordTypeRequest do
  #let(:instance) { Spatio::UpdateRecordTypeRequest.new }

  describe 'test an instance of UpdateRecordTypeRequest' do
    it 'should create an instance of UpdateRecordTypeRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateRecordTypeRequest)
    end
  end
