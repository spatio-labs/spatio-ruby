...
# Unit tests for Spatio::CreatePATRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreatePATRequest do
  #let(:instance) { Spatio::CreatePATRequest.new }

  describe 'test an instance of CreatePATRequest' do
    it 'should create an instance of CreatePATRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreatePATRequest)
    end
  end
