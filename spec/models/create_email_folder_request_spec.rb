...
# Unit tests for Spatio::CreateEmailFolderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateEmailFolderRequest do
  #let(:instance) { Spatio::CreateEmailFolderRequest.new }

  describe 'test an instance of CreateEmailFolderRequest' do
    it 'should create an instance of CreateEmailFolderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateEmailFolderRequest)
    end
  end
