...
# Unit tests for Spatio::ContactCategory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ContactCategory do
  #let(:instance) { Spatio::ContactCategory.new }

  describe 'test an instance of ContactCategory' do
    it 'should create an instance of ContactCategory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ContactCategory)
    end
  end
