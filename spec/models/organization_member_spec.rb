...
# Unit tests for Spatio::OrganizationMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::OrganizationMember do
  #let(:instance) { Spatio::OrganizationMember.new }

  describe 'test an instance of OrganizationMember' do
    it 'should create an instance of OrganizationMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::OrganizationMember)
    end
  end
