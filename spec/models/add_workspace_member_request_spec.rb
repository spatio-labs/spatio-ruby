...
# Unit tests for Spatio::AddWorkspaceMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AddWorkspaceMemberRequest do
  #let(:instance) { Spatio::AddWorkspaceMemberRequest.new }

  describe 'test an instance of AddWorkspaceMemberRequest' do
    it 'should create an instance of AddWorkspaceMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AddWorkspaceMemberRequest)
    end
  end
