...
# Unit tests for Spatio::WorkspaceMemberListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::WorkspaceMemberListResponse do
  #let(:instance) { Spatio::WorkspaceMemberListResponse.new }

  describe 'test an instance of WorkspaceMemberListResponse' do
    it 'should create an instance of WorkspaceMemberListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::WorkspaceMemberListResponse)
    end
  end
