...
# Unit tests for Spatio::ListChannelsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListChannelsResponse do
  #let(:instance) { Spatio::ListChannelsResponse.new }

  describe 'test an instance of ListChannelsResponse' do
    it 'should create an instance of ListChannelsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListChannelsResponse)
    end
  end
