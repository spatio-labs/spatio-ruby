...
# Unit tests for Spatio::CreateRowRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateRowRequest do
  #let(:instance) { Spatio::CreateRowRequest.new }

  describe 'test an instance of CreateRowRequest' do
    it 'should create an instance of CreateRowRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateRowRequest)
    end
  end
