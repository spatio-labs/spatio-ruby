...
# Unit tests for Spatio::DMReactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMReactionRequest do
  #let(:instance) { Spatio::DMReactionRequest.new }

  describe 'test an instance of DMReactionRequest' do
    it 'should create an instance of DMReactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMReactionRequest)
    end
  end
