...
# Unit tests for Spatio::CalendarCapabilitiesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarCapabilitiesResponse do
  #let(:instance) { Spatio::CalendarCapabilitiesResponse.new }

  describe 'test an instance of CalendarCapabilitiesResponse' do
    it 'should create an instance of CalendarCapabilitiesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarCapabilitiesResponse)
    end
  end
