...
# Unit tests for Spatio::DMMuteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMMuteResponse do
  #let(:instance) { Spatio::DMMuteResponse.new }

  describe 'test an instance of DMMuteResponse' do
    it 'should create an instance of DMMuteResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMMuteResponse)
    end
  end
