...
# Unit tests for Spatio::UpdateTaskRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateTaskRequest do
  #let(:instance) { Spatio::UpdateTaskRequest.new }

  describe 'test an instance of UpdateTaskRequest' do
    it 'should create an instance of UpdateTaskRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateTaskRequest)
    end
  end
