...
# Unit tests for Spatio::CreateRoutineRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateRoutineRequest do
  #let(:instance) { Spatio::CreateRoutineRequest.new }

  describe 'test an instance of CreateRoutineRequest' do
    it 'should create an instance of CreateRoutineRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateRoutineRequest)
    end
  end
