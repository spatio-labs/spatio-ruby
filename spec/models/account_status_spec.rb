...
# Unit tests for Spatio::AccountStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AccountStatus do
  #let(:instance) { Spatio::AccountStatus.new }

  describe 'test an instance of AccountStatus' do
    it 'should create an instance of AccountStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AccountStatus)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["ok", "error", "skipped"])
