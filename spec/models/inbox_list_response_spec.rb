...
# Unit tests for Spatio::InboxListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InboxListResponse do
  #let(:instance) { Spatio::InboxListResponse.new }

  describe 'test an instance of InboxListResponse' do
    it 'should create an instance of InboxListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InboxListResponse)
    end
  end
