...
# Unit tests for Spatio::ListMessagesResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListMessagesResponse do
  #let(:instance) { Spatio::ListMessagesResponse.new }

  describe 'test an instance of ListMessagesResponse' do
    it 'should create an instance of ListMessagesResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListMessagesResponse)
    end
  end
