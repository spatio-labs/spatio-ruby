...
# Unit tests for Spatio::BulkMoveFilesRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkMoveFilesRequest do
  #let(:instance) { Spatio::BulkMoveFilesRequest.new }

  describe 'test an instance of BulkMoveFilesRequest' do
    it 'should create an instance of BulkMoveFilesRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkMoveFilesRequest)
    end
  end
  ...
  describe 'test attribute "target_folder_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
