...
# Unit tests for Spatio::DMMessageEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMMessageEnvelope do
  #let(:instance) { Spatio::DMMessageEnvelope.new }

  describe 'test an instance of DMMessageEnvelope' do
    it 'should create an instance of DMMessageEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMMessageEnvelope)
    end
  end
