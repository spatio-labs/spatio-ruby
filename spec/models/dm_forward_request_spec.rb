...
# Unit tests for Spatio::DMForwardRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMForwardRequest do
  #let(:instance) { Spatio::DMForwardRequest.new }

  describe 'test an instance of DMForwardRequest' do
    it 'should create an instance of DMForwardRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMForwardRequest)
    end
  end

  describe 'test attribute "to_dm_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "to_channel_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
