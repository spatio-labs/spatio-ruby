...
# Unit tests for Spatio::CreateNoteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateNoteRequest do
  #let(:instance) { Spatio::CreateNoteRequest.new }

  describe 'test an instance of CreateNoteRequest' do
    it 'should create an instance of CreateNoteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateNoteRequest)
    end
  end
