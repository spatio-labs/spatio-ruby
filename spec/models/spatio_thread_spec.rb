...
# Unit tests for Spatio::SpatioThread
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SpatioThread do
  #let(:instance) { Spatio::SpatioThread.new }

  describe 'test an instance of SpatioThread' do
    it 'should create an instance of SpatioThread' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SpatioThread)
    end
  end
