...
# Unit tests for Spatio::EmailFolderListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::EmailFolderListResponse do
  #let(:instance) { Spatio::EmailFolderListResponse.new }

  describe 'test an instance of EmailFolderListResponse' do
    it 'should create an instance of EmailFolderListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::EmailFolderListResponse)
    end
  end
