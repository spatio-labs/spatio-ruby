...
# Unit tests for Spatio::ListEmailsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ListEmailsResponse do
  #let(:instance) { Spatio::ListEmailsResponse.new }

  describe 'test an instance of ListEmailsResponse' do
    it 'should create an instance of ListEmailsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ListEmailsResponse)
    end
  end
