...
# Unit tests for Spatio::AttendeeStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AttendeeStatus do
  #let(:instance) { Spatio::AttendeeStatus.new }

  describe 'test an instance of AttendeeStatus' do
    it 'should create an instance of AttendeeStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AttendeeStatus)
    end
  end
