...
# Unit tests for Spatio::InboxCounts
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::InboxCounts do
  #let(:instance) { Spatio::InboxCounts.new }

  describe 'test an instance of InboxCounts' do
    it 'should create an instance of InboxCounts' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::InboxCounts)
    end
  end
