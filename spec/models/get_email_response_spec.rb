...
# Unit tests for Spatio::GetEmailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::GetEmailResponse do
  #let(:instance) { Spatio::GetEmailResponse.new }

  describe 'test an instance of GetEmailResponse' do
    it 'should create an instance of GetEmailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::GetEmailResponse)
    end
  end
