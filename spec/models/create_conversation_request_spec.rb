...
# Unit tests for Spatio::CreateConversationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateConversationRequest do
  #let(:instance) { Spatio::CreateConversationRequest.new }
  ...
  describe 'test an instance of CreateConversationRequest' do
    it 'should create an instance of CreateConversationRequest' do
      ...
      #expect(instance).to be_instance_of(Spatio::CreateConversationRequest)
    end
  end
