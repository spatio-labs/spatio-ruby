...
# Unit tests for Spatio::CallRecording
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CallRecording do
  #let(:instance) { Spatio::CallRecording.new }

  describe 'test an instance of CallRecording' do
    it 'should create an instance of CallRecording' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CallRecording)
    end
  end
