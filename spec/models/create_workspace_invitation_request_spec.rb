...
# Unit tests for Spatio::CreateWorkspaceInvitationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateWorkspaceInvitationRequest do
  #let(:instance) { Spatio::CreateWorkspaceInvitationRequest.new }

  describe 'test an instance of CreateWorkspaceInvitationRequest' do
    it 'should create an instance of CreateWorkspaceInvitationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateWorkspaceInvitationRequest)
    end
  end
