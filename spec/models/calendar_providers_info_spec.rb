...
# Unit tests for Spatio::CalendarProvidersInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CalendarProvidersInfo do
  #let(:instance) { Spatio::CalendarProvidersInfo.new }

  describe 'test an instance of CalendarProvidersInfo' do
    it 'should create an instance of CalendarProvidersInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CalendarProvidersInfo)
    end
  end
