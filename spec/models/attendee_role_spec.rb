...
# Unit tests for Spatio::AttendeeRole
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AttendeeRole do
  #let(:instance) { Spatio::AttendeeRole.new }

  describe 'test an instance of AttendeeRole' do
    it 'should create an instance of AttendeeRole' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AttendeeRole)
    end
  end
