...
# Unit tests for Spatio::GetChatUserResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::GetChatUserResponse do
  #let(:instance) { Spatio::GetChatUserResponse.new }

  describe 'test an instance of GetChatUserResponse' do
    it 'should create an instance of GetChatUserResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::GetChatUserResponse)
    end
  end
