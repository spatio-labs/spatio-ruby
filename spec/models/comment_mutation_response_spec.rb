...
# Unit tests for Spatio::CommentMutationResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CommentMutationResponse do
  #let(:instance) { Spatio::CommentMutationResponse.new }

  describe 'test an instance of CommentMutationResponse' do
    it 'should create an instance of CommentMutationResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CommentMutationResponse)
    end
  end
