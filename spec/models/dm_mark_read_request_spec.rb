...
# Unit tests for Spatio::DMMarkReadRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMMarkReadRequest do
  #let(:instance) { Spatio::DMMarkReadRequest.new }

  describe 'test an instance of DMMarkReadRequest' do
    it 'should create an instance of DMMarkReadRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMMarkReadRequest)
    end
  end
