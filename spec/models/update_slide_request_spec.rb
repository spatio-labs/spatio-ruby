...
# Unit tests for Spatio::UpdateSlideRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateSlideRequest do
  #let(:instance) { Spatio::UpdateSlideRequest.new }

  describe 'test an instance of UpdateSlideRequest' do
    it 'should create an instance of UpdateSlideRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateSlideRequest)
    end
  end
