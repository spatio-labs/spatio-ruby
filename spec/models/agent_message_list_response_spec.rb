...
# Unit tests for Spatio::AgentMessageListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AgentMessageListResponse do
  #let(:instance) { Spatio::AgentMessageListResponse.new }

  describe 'test an instance of AgentMessageListResponse' do
    it 'should create an instance of AgentMessageListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AgentMessageListResponse)
    end
  end
