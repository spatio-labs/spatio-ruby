...
# Unit tests for Spatio::RevokeOtherSessionsResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::RevokeOtherSessionsResponse do
  #let(:instance) { Spatio::RevokeOtherSessionsResponse.new }

  describe 'test an instance of RevokeOtherSessionsResponse' do
    it 'should create an instance of RevokeOtherSessionsResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::RevokeOtherSessionsResponse)
    end
  end
