...
# Unit tests for Spatio::ChatMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ChatMessage do
  #let(:instance) { Spatio::ChatMessage.new }

  describe 'test an instance of ChatMessage' do
    it 'should create an instance of ChatMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ChatMessage)
    end
  end
