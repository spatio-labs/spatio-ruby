...
# Unit tests for Spatio::UpdateRoutineRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateRoutineRequest do
  #let(:instance) { Spatio::UpdateRoutineRequest.new }

  describe 'test an instance of UpdateRoutineRequest' do
    it 'should create an instance of UpdateRoutineRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateRoutineRequest)
    end
  end
