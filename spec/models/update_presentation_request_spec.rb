...
# Unit tests for Spatio::UpdatePresentationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdatePresentationRequest do
  #let(:instance) { Spatio::UpdatePresentationRequest.new }

  describe 'test an instance of UpdatePresentationRequest' do
    it 'should create an instance of UpdatePresentationRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdatePresentationRequest)
    end
  end
