...
# Unit tests for Spatio::BlockType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BlockType do
  #let(:instance) { Spatio::BlockType.new }

  describe 'test an instance of BlockType' do
    it 'should create an instance of BlockType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BlockType)
    end
  end
