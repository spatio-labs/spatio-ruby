...
# Unit tests for Spatio::ReminderMethod
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ReminderMethod do
  #let(:instance) { Spatio::ReminderMethod.new }

  describe 'test an instance of ReminderMethod' do
    it 'should create an instance of ReminderMethod' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ReminderMethod)
    end
  end
