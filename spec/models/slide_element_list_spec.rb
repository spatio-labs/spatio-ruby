...
# Unit tests for Spatio::SlideElementList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SlideElementList do
  #let(:instance) { Spatio::SlideElementList.new }

  describe 'test an instance of SlideElementList' do
    it 'should create an instance of SlideElementList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SlideElementList)
    end
  end
