...
# Unit tests for Spatio::CreateChannelResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateChannelResponse do
  #let(:instance) { Spatio::CreateChannelResponse.new }

  describe 'test an instance of CreateChannelResponse' do
    it 'should create an instance of CreateChannelResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateChannelResponse)
    end
  end
