...
# Unit tests for Spatio::Routine
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::Routine do
  #let(:instance) { Spatio::Routine.new }

  describe 'test an instance of Routine' do
    it 'should create an instance of Routine' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::Routine)
    end
  end
