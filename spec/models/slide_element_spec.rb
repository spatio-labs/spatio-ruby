...
# Unit tests for Spatio::SlideElement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SlideElement do
  #let(:instance) { Spatio::SlideElement.new }

  describe 'test an instance of SlideElement' do
    it 'should create an instance of SlideElement' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SlideElement)
    end
  end
