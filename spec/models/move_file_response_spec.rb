...
# Unit tests for Spatio::MoveFileResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::MoveFileResponse do
  #let(:instance) { Spatio::MoveFileResponse.new }

  describe 'test an instance of MoveFileResponse' do
    it 'should create an instance of MoveFileResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::MoveFileResponse)
    end
  end
