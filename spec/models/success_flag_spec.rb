...
# Unit tests for Spatio::SuccessFlag
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SuccessFlag do
  #let(:instance) { Spatio::SuccessFlag.new }

  describe 'test an instance of SuccessFlag' do
    it 'should create an instance of SuccessFlag' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SuccessFlag)
    end
  end
