...
# Unit tests for Spatio::ConnectedAppItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ConnectedAppItem do
  #let(:instance) { Spatio::ConnectedAppItem.new }

  describe 'test an instance of ConnectedAppItem' do
    it 'should create an instance of ConnectedAppItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ConnectedAppItem)
    end
  end
  ...
  describe 'test attribute "scope_labels"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
