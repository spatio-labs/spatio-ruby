...
# Unit tests for Spatio::SlideList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SlideList do
  #let(:instance) { Spatio::SlideList.new }

  describe 'test an instance of SlideList' do
    it 'should create an instance of SlideList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SlideList)
    end
  end

  describe 'test attribute "slides"' do
    it 'should work' do
