...
# Unit tests for Spatio::ReplyEmailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::ReplyEmailRequest do
  #let(:instance) { Spatio::ReplyEmailRequest.new }

  describe 'test an instance of ReplyEmailRequest' do
    it 'should create an instance of ReplyEmailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::ReplyEmailRequest)
    end
  end
