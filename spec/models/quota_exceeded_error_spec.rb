...
# Unit tests for Spatio::QuotaExceededError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::QuotaExceededError do
  #let(:instance) { Spatio::QuotaExceededError.new }

  describe 'test an instance of QuotaExceededError' do
    it 'should create an instance of QuotaExceededError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::QuotaExceededError)
    end
  end
