...
# Unit tests for Spatio::CallRecordingListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CallRecordingListResponse do
  #let(:instance) { Spatio::CallRecordingListResponse.new }

  describe 'test an instance of CallRecordingListResponse' do
    it 'should create an instance of CallRecordingListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CallRecordingListResponse)
    end
  end
