...
# Unit tests for Spatio::UpdateAccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateAccountRequest do
  #let(:instance) { Spatio::UpdateAccountRequest.new }

  describe 'test an instance of UpdateAccountRequest' do
    it 'should create an instance of UpdateAccountRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateAccountRequest)
    end
  end
