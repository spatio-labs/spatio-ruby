...
# Unit tests for Spatio::CoreAction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CoreAction do
  #let(:instance) { Spatio::CoreAction.new }

  describe 'test an instance of CoreAction' do
    it 'should create an instance of CoreAction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CoreAction)
    end
  end
