...
# Unit tests for Spatio::DMSearchResults
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMSearchResults do
  #let(:instance) { Spatio::DMSearchResults.new }

  describe 'test an instance of DMSearchResults' do
    it 'should create an instance of DMSearchResults' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMSearchResults)
    end
  end
