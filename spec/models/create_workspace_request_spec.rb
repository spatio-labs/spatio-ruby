...
# Unit tests for Spatio::CreateWorkspaceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateWorkspaceRequest do
  #let(:instance) { Spatio::CreateWorkspaceRequest.new }

  describe 'test an instance of CreateWorkspaceRequest' do
    it 'should create an instance of CreateWorkspaceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateWorkspaceRequest)
    end
  end
