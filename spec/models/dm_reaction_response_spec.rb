...
# Unit tests for Spatio::DMReactionResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::DMReactionResponse do
  #let(:instance) { Spatio::DMReactionResponse.new }

  describe 'test an instance of DMReactionResponse' do
    it 'should create an instance of DMReactionResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::DMReactionResponse)
    end
  end
