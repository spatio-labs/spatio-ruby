...
# Unit tests for Spatio::TaskListEnvelope
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::TaskListEnvelope do
  #let(:instance) { Spatio::TaskListEnvelope.new }

  describe 'test an instance of TaskListEnvelope' do
    it 'should create an instance of TaskListEnvelope' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::TaskListEnvelope)
    end
  end
