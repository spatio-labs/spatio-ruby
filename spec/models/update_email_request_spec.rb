...
# Unit tests for Spatio::UpdateEmailRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::UpdateEmailRequest do
  #let(:instance) { Spatio::UpdateEmailRequest.new }

  describe 'test an instance of UpdateEmailRequest' do
    it 'should create an instance of UpdateEmailRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::UpdateEmailRequest)
    end
  end
  ...
  describe 'test attribute "add_labels"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "remove_labels"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
