...
# Unit tests for Spatio::SaveMessageRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::SaveMessageRequest do
  #let(:instance) { Spatio::SaveMessageRequest.new }

  describe 'test an instance of SaveMessageRequest' do
    it 'should create an instance of SaveMessageRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::SaveMessageRequest)
    end
  end
