...
# Unit tests for Spatio::CreateCalendarEvent201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::CreateCalendarEvent201Response do
  #let(:instance) { Spatio::CreateCalendarEvent201Response.new }

  describe 'test an instance of CreateCalendarEvent201Response' do
    it 'should create an instance of CreateCalendarEvent201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::CreateCalendarEvent201Response)
    end
  end
