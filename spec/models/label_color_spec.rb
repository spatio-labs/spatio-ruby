...
# Unit tests for Spatio::LabelColor
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::LabelColor do
  #let(:instance) { Spatio::LabelColor.new }

  describe 'test an instance of LabelColor' do
    it 'should create an instance of LabelColor' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::LabelColor)
    end
  end
