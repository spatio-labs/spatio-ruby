...
# Unit tests for Spatio::BulkFilesResponseFailedInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::BulkFilesResponseFailedInner do
  #let(:instance) { Spatio::BulkFilesResponseFailedInner.new }

  describe 'test an instance of BulkFilesResponseFailedInner' do
    it 'should create an instance of BulkFilesResponseFailedInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::BulkFilesResponseFailedInner)
    end
  end
