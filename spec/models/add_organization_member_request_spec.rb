...
# Unit tests for Spatio::AddOrganizationMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Spatio::AddOrganizationMemberRequest do
  #let(:instance) { Spatio::AddOrganizationMemberRequest.new }

  describe 'test an instance of AddOrganizationMemberRequest' do
    it 'should create an instance of AddOrganizationMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Spatio::AddOrganizationMemberRequest)
    end
  end
