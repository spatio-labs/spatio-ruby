...
module Spatio
  class CreateLabelRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::CreateLabelRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::CreateLabelRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'message_list_visibility')
        self.message_list_visibility = attributes[:'message_list_visibility']
      end

      if attributes.key?(:'label_list_visibility')
        self.label_list_visibility = attributes[:'label_list_visibility']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          name == o.name &&
          message_list_visibility == o.message_list_visibility &&
          label_list_visibility == o.label_list_visibility &&
          color == o.color
    end
    ...
    def hash
      [account_id, name, message_list_visibility, label_list_visibility, color].hash
    end
