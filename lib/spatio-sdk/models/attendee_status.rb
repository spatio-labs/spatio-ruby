...
module Spatio
  class AttendeeStatus
    ...
    def self.all_vars
      @all_vars ||= [NEEDS_ACTION, ACCEPTED, DECLINED, TENTATIVE].freeze
    end
    ...
    def build_from_hash(value)
      return value if AttendeeStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #AttendeeStatus"
    end
  end
end
