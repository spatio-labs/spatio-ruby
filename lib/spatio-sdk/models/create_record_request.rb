...
module Spatio
  class CreateRecordRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::CreateRecordRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::CreateRecordRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @record_type_id.nil?
        invalid_properties.push('invalid value for "record_type_id", record_type_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @record_type_id.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] record_type_id Value to be assigned
    def record_type_id=(record_type_id)
      if record_type_id.nil?
        fail ArgumentError, 'record_type_id cannot be nil'
      end
    ...
    def hash
      [organization_id, record_type_id, name, attributes, metadata].hash
    end
