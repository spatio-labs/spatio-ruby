...
module Spatio
  ...
  class AccountListResponse < ApiModelBase
    attr_accessor :accounts_by_platform
    ...
    def self.openapi_types
      {
        :'accounts_by_platform' => :'Hash<String, Object>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::AccountListResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::AccountListResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'accounts_by_platform')
        if (value = attributes[:'accounts_by_platform']).is_a?(Hash)
          self.accounts_by_platform = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          accounts_by_platform == o.accounts_by_platform &&
    ...
    def hash
      [accounts_by_platform, total_accounts, accounts].hash
    end
