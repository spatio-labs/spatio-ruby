...
module Spatio
  ...
  class PublicInvitationPayload < ApiModelBase
    attr_accessor :kind
    ...
    def self.openapi_types
      {
        ...
        :'expires_at' => :'Time',
        :'created_at' => :'Time',
        :'workspace' => :'Hash<String, Object>',
        :'organization' => :'Hash<String, Object>',
        :'invited_by' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::PublicInvitationPayload` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::PublicInvitationPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'workspace')
        if (value = attributes[:'workspace']).is_a?(Hash)
      ...
      if attributes.key?(:'invited_by')
        if (value = attributes[:'invited_by']).is_a?(Hash)
    ...
    def valid?
      ...
      kind_validator = EnumAttributeValidator.new('String', ["workspace", "organization"])
    ...
    def kind=(kind)
      validator = EnumAttributeValidator.new('String', ["workspace", "organization"])
    ...
    def hash
      [kind, id, workspace_id, organization_id, email, role, status, expires_at, created_at, workspace, organization, invited_by].hash
    end
