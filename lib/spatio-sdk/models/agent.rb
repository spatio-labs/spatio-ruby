...
module Spatio
  ...
  class Agent < ApiModelBase
    ...
    attr_accessor :is_preconfigured
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::Agent` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::Agent`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_preconfigured')
        self.is_preconfigured = attributes[:'is_preconfigured']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          is_preconfigured == o.is_preconfigured &&
    ...
    def hash
      [id, name, description, system_prompt, tools, icon, color, is_default, is_preconfigured, created_at, updated_at, metadata].hash
    end
