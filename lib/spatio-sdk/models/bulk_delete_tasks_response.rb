...
module Spatio
  ...
  class BulkDeleteTasksResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::BulkDeleteTasksResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::BulkDeleteTasksResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'affected_count')
        self.affected_count = attributes[:'affected_count']
      else
        self.affected_count = nil
      end
    ...
    def list_invalid_properties
      ...
      if @affected_count.nil?
        invalid_properties.push('invalid value for "affected_count", affected_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @affected_count.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] affected_count Value to be assigned
    def affected_count=(affected_count)
      if affected_count.nil?
        fail ArgumentError, 'affected_count cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] task_ids Value to be assigned
    def task_ids=(task_ids)
      if task_ids.nil?
        fail ArgumentError, 'task_ids cannot be nil'
      end
    ...
    def hash
      [success, affected_count, task_ids, failed].hash
    end
