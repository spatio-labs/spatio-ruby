...
module Spatio
  ...
  class ChunkedFileManifest < ApiModelBase
    ...
    attr_accessor :chunking_algorithm
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::ChunkedFileManifest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::ChunkedFileManifest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'chunking_algorithm')
        self.chunking_algorithm = attributes[:'chunking_algorithm']
      end

      if attributes.key?(:'file_checksum')
        self.file_checksum = attributes[:'file_checksum']
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] block_count Value to be assigned
    def block_count=(block_count)
      if block_count.nil?
        fail ArgumentError, 'block_count cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          chunking_algorithm == o.chunking_algorithm &&
          file_checksum == o.file_checksum &&
          blocks == o.blocks
    end
    ...
    def hash
      [manifest_id, file_id, file_name, version, total_size, block_count, chunking_algorithm, file_checksum, blocks].hash
    end
