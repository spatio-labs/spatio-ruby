...
module Spatio
  ...
  class BulkMoveFilesRequest < ApiModelBase
    ...
    attr_accessor :target_folder_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::BulkMoveFilesRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::BulkMoveFilesRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'target_folder_id')
        self.target_folder_id = attributes[:'target_folder_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          target_folder_id == o.target_folder_id &&
    ...
    def hash
      [file_ids, account_ids, account_id, target_folder_id, folder_id].hash
    end
