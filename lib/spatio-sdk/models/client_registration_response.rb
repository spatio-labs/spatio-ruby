...
module Spatio
  class ClientRegistrationResponse < ApiModelBase
    ...
    # Custom attribute writer method with validation
    # @param [Object] registration_access_token Value to be assigned
    def registration_access_token=(registration_access_token)
      if registration_access_token.nil?
        fail ArgumentError, 'registration_access_token cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] client_id_issued_at Value to be assigned
    def client_id_issued_at=(client_id_issued_at)
      if client_id_issued_at.nil?
        fail ArgumentError, 'client_id_issued_at cannot be nil'
      end
