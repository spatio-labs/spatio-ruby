...
module Spatio
  class CreateOrganizationRequest < ApiModelBase
    ...
    attr_accessor :create_default_workspace
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::CreateOrganizationRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::CreateOrganizationRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'create_default_workspace')
        self.create_default_workspace = attributes[:'create_default_workspace']
      end

      if attributes.key?(:'default_workspace_name')
        self.default_workspace_name = attributes[:'default_workspace_name']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          logo_url == o.logo_url &&
          create_default_workspace == o.create_default_workspace &&
          default_workspace_name == o.default_workspace_name
    end
    ...
    def hash
      [name, slug, description, logo_url, create_default_workspace, default_workspace_name].hash
    end
