...
module Spatio
  ...
  class UpdateParticipantStateRequest < ApiModelBase
    attr_accessor :audio_enabled

    attr_accessor :video_enabled

    attr_accessor :screen_share_enabled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::UpdateParticipantStateRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::UpdateParticipantStateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'audio_enabled')
        self.audio_enabled = attributes[:'audio_enabled']
      end

      if attributes.key?(:'video_enabled')
        self.video_enabled = attributes[:'video_enabled']
      end

      if attributes.key?(:'screen_share_enabled')
        self.screen_share_enabled = attributes[:'screen_share_enabled']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          video_enabled == o.video_enabled &&
          screen_share_enabled == o.screen_share_enabled
    end
    ...
    def hash
      [audio_enabled, video_enabled, screen_share_enabled].hash
    end
