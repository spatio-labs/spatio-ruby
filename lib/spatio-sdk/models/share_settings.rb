...
module Spatio
  ...
  class ShareSettings < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::ShareSettings` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::ShareSettings`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'password_set_at')
        self.password_set_at = attributes[:'password_set_at']
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] has_password Value to be assigned
    def has_password=(has_password)
      if has_password.nil?
        fail ArgumentError, 'has_password cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password_set_at == o.password_set_at
    end
    ...
    def hash
      [is_public, has_password, share_token, share_url, password_set_at].hash
    end
