  ...
  class SpatioCall < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'workspace_id' => :'String',
        :'room_id' => :'String',
        :'participants' => :'Array<Hash<String, Object>>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::SpatioCall` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::SpatioCall`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'host_user_id')
        self.host_user_id = attributes[:'host_user_id']
      end
    ...
    def hash
      [id, title, status, host_user_id, workspace_id, room_id, participants, metadata, started_at, ended_at, created_at].hash
    end
