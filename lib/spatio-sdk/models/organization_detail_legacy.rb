...
module Spatio
  ...
  class OrganizationDetailLegacy < ApiModelBase
    attr_accessor :id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::OrganizationDetailLegacy` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::OrganizationDetailLegacy`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @subscription_tier.nil?
        invalid_properties.push('invalid value for "subscription_tier", subscription_tier cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @subscription_tier.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] subscription_tier Value to be assigned
    def subscription_tier=(subscription_tier)
      if subscription_tier.nil?
        fail ArgumentError, 'subscription_tier cannot be nil'
      end
    ...
    def hash
      [id, name, slug, description, logo_url, settings, subscription_tier, deployment_type, subscription_status, created_at, updated_at].hash
    end
