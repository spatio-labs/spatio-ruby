...
module Spatio
  ...
  class PasswordRequiredError < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Spatio::PasswordRequiredError` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Spatio::PasswordRequiredError`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'requires_password')
        self.requires_password = attributes[:'requires_password']
      else
        self.requires_password = nil
      end

      if attributes.key?(:'invalid_password')
        self.invalid_password = attributes[:'invalid_password']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @requires_password.nil?
        invalid_properties.push('invalid value for "requires_password", requires_password cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @requires_password.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] requires_password Value to be assigned
    def requires_password=(requires_password)
      if requires_password.nil?
        fail ArgumentError, 'requires_password cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          error == o.error &&
          code == o.code &&
          requires_password == o.requires_password &&
          invalid_password == o.invalid_password
    end
    ...
    def hash
      [error, code, requires_password, invalid_password].hash
    end
